...
`},{link:"blog-5",img:"",title:"Introduction to Forex Trading with The Funded Hub: A Beginner's Guide",para:`<span>Meta Description:</span> Explore the power of leverage
          ...
          `},{link:"blog-12",img:"",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function We(){let[a,t]=i.useState(1);const r=6,c=Math.ceil(L.length/r),s=qe(L,r),l=(h,p)=>{t(p),s.jump(p)},d=se({palette:{mode:"dark"}});return e.jsxs(e.Fragment,{children:[e.jsx(w,{}),e.jsxs("section",{className:"blog relative pt-32 sm:pt-48 pb-28 sm:pb-44 overflow-hidden",children:[e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"header flex justify-between w-full",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.7rem] tracking-tight text-wht-gradient",children:"Blog"})}),e.jsx("div",{className:"blogs mt-12 grid sm:grid-cols-2 md:grid-cols-3 gap-6 relative",children:s.currentData().map((h,p)=>e.jsxs(o,{to:`/blog/${h.link}`,className:"single-blog p-[0.9rem] bg-light/20 backdrop-blur-3xl rounded-xl !relative global-shadow grid justify-between items-end gap-4",children:[e.jsx("div",{className:"blog-img rounded-md hidden",children:e.jsx("img",{className:"rounded-md w-full h-full leading-none",src:h.img,alt:h.alt})}),e.jsxs("div",{className:"texts fmt-6 grid gap-3 pb-8",children:[e.jsx("h3",{className:"font-semibold",children:h.title}),e.jsx("div",{className:"blog-para-slice",children:e.jsx("p",{dangerouslySetInnerHTML:{__html:h.para.slice(0,140)+"...."}})}),e.jsx("div",{className:"date text-sm absolute bottom-3",children:h.date})]})]},h.title+p))}),e.jsx("div",{className:"pagination mt-10 flex justify-center",children:e.jsx(re,{theme:d,children:e.jsx(ne,{spacing:2,children:e.jsx(oe,{count:c,page:a,shape:"rounded",variant:"outlined",color:"secondary",onChange:l})})})})]})}),e.jsx("div",{className:"circle-shadow absolute opacity-[23%] -top-[10%] -left-[50%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:x,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow absolute opacity-[25%] top-[40%] -right-[20%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:x,alt:"circle-shadow"})})]}),e.jsx(j,{})]})}function ze(){const{pathname:a}=v(),t=L.filter(({link:r})=>r===a.slice(6));return e.jsxs(e.Fragment,{children:[e.jsx(w,{}),e.jsx("section",{className:"single-blog relative pt-32 sm:pt-48 pb-28 sm:pb-44 overflow-hidden",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"flex justify-center items-center blog-content",children:e.jsx("div",{className:"blog-img p-[0.03rem] rounded-md",children:e.jsx("img",{className:"rounded-md",src:"",alt:t.alt})})}),e.jsxs("div",{className:"blog-content ",children:[e.jsx("div",{className:"heading",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.9rem] tracking-tight text-wht-gradient",children:t[0].title})}),e.jsxs("div",{className:"blog-wrap-data global-shadow",children:[e.jsx("div",{className:"data ",dangerouslySetInnerHTML:{__html:t[0].data}}),e.jsx("div",{className:"btn mt-10 m-auto max-w-[17rem]",children:e.jsx(o,{to:"/",className:"uppercase font-Montserrat text-sm font-semibold  transition-all duration-200 glowing-btn",children:"Get Funded now"})})]})]})]})})}),e.jsx(j,{})]})}function Be(){return e.jsxs("div",{className:"App body-background",children:[e.jsx(J,{children:e.jsxs(Z,{children:[e.jsx(b,{path:"/",element:e.jsx(Fe,{})}),e.jsx(b,{path:"login",element:e.jsx(Ie,{})}),e.jsx(b,{path:"contact",element:e.jsx(Ae,{})}),e.jsx(b,{path:"faq",element:e.jsx(Pe,{})}),e.jsx(b,{path:"cookie-policy",element:e.jsx(Le,{})}),e.jsx(b,{path:"privacy-policy",element:e.jsx(Me,{})}),e.jsx(b,{path:"terms-condition",element:e.jsx(Oe,{})}),e.jsx(b,{path:"risk-disclosure",element:e.jsx(De,{})}),e.jsx(b,{path:"report-problem",element:e.jsx(Re,{})}),e.jsx(b,{path:"blog",element:e.jsx(We,{})}),e.jsx(b,{path:"blog/:blog",element:e.jsx(ze,{})})]})}),e.jsx($e,{})]})}_.createRoot(document.getElementById("root")).render(e.jsx(G.StrictMode,{children:e.jsx(Be,{})}));
