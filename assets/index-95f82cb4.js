...
`},{link:"blog-5",title:"Introduction to Forex Trading with The Funded Hub: A Beginner&apos;s Guide",para:`<span>Meta Description:</span> Explore the power of leverage
          ...
          `},{link:"blog-12",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function Ga(){const{pathname:a}=b(),t=$a.filter(({link:i})=>i===a.slice(6));return e.jsxs(e.Fragment,{children:[e.jsx(C,{}),e.jsx("section",{className:"single-blog relative pt-32 sm:pt-48 pb-28 sm:pb-44 purple-shadow",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"flex justify-center items-center",children:e.jsx("div",{className:"blog-img p-[0.03rem] rounded-md",children:e.jsx("img",{className:"rounded-md",src:se,alt:""})})}),e.jsxs("div",{className:"blog-content",children:[e.jsx("div",{className:"heading",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.9rem] tracking-tight text-wht-gradient",children:t[0].title})}),e.jsxs("div",{className:"blog-wrap-data",children:[e.jsx("div",{className:"data",dangerouslySetInnerHTML:{__html:t[0].data}}),e.jsx("div",{className:"btn mt-10 m-auto max-w-[17rem]",children:e.jsx(o,{to:"/",className:"uppercase font-Montserrat text-sm font-semibold  transition-all duration-200 glowing-btn",children:"Get Funded now"})})]})]})]})})}),e.jsx(S,{})]})}function Va(){return e.jsx("div",{className:"App",children:e.jsx(ce,{children:e.jsxs(me,{children:[e.jsx(x,{path:"/",element:e.jsx(la,{})}),e.jsx(x,{path:"login",element:e.jsx(ca,{})}),e.jsx(x,{path:"contact",element:e.jsx(ha,{})}),e.jsx(x,{path:"faq",element:e.jsx(pa,{})}),e.jsx(x,{path:"checkout",element:e.jsx(qa,{})}),e.jsx(x,{path:"cookie-policy",element:e.jsx(ma,{})}),e.jsx(x,{path:"privacy-policy",element:e.jsx(ua,{})}),e.jsx(x,{path:"terms-condition",element:e.jsx(fa,{})}),e.jsx(x,{path:"risk-disclosure",element:e.jsx(xa,{})}),e.jsx(x,{path:"report-problem",element:e.jsx(ga,{})}),e.jsx(x,{path:"blog",element:e.jsx(Ya,{})}),e.jsx(x,{path:"blog/:blog",element:e.jsx(Ga,{})}),e.jsxs(x,{path:"dashboard",element:e.jsx(wa,{}),children:[e.jsx(x,{path:"Profile",element:e.jsx(Aa,{})}),e.jsx(x,{path:"billing",element:e.jsx(Ma,{})}),e.jsx(x,{path:"withdraw",element:e.jsx(Ca,{})}),e.jsx(x,{path:"top-up-reset",element:e.jsx(Sa,{})}),e.jsx(x,{path:"help",element:e.jsx(Pa,{})}),e.jsx(x,{path:"dashboard-contact",element:e.jsx(Fa,{})}),e.jsx(x,{path:"certificate",element:e.jsx(Oa,{})})]})]})})})}de.createRoot(document.getElementById("root")).render(e.jsx(le.StrictMode,{children:e.jsx(Va,{})}));
