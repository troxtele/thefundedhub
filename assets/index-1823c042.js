...
`},{link:"blog-5",img:"",title:"Introduction to Forex Trading with The Funded Hub: A Beginner's Guide",para:`<span></span> Explore the power of leverage
          ...
          `},{link:"blog-12",img:"",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function Ve(){let[a,t]=s.useState(1);const r=6,n=Math.ceil(W.length/r),i=Ue(W,r),c=(h,u)=>{t(u),i.jump(u)},d=le({palette:{mode:"dark"}});return e.jsxs(e.Fragment,{children:[e.jsx(A,{}),e.jsxs("section",{className:"blog relative fpt-32 pt-36 sm:pt-48 pb-28 sm:pb-44 overflow-hidden",children:[e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"header flex justify-between w-full",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.7rem] tracking-tight text-wht-gradient",children:"Blog"})}),e.jsx("div",{className:"blogs mt-12 grid sm:grid-cols-2 md:grid-cols-3 gap-6 relative",children:i.currentData().map((h,u)=>e.jsxs(o,{to:`/blog/${h.link}`,className:"single-blog p-[0.9rem] bg-light/20 backdrop-blur-3xl rounded-xl !relative global-shadow grid justify-between items-end gap-4",children:[e.jsx("div",{className:"blog-img rounded-md hidden",children:e.jsx("img",{className:"rounded-md w-full h-full leading-none",src:h.img,alt:h.alt})}),e.jsxs("div",{className:"texts fmt-6 grid gap-3 pb-8",children:[e.jsx("h3",{className:"font-semibold",children:h.title}),e.jsx("div",{className:"blog-para-slice",children:e.jsx("p",{dangerouslySetInnerHTML:{__html:h.para.slice(0,140)+"...."}})}),e.jsx("div",{className:"date text-sm absolute bottom-3",children:h.date})]})]},h.title+u))}),e.jsx("div",{className:"pagination mt-10 flex justify-center",children:e.jsx(ce,{theme:d,children:e.jsx(de,{spacing:2,children:e.jsx(he,{count:n,page:a,shape:"rounded",variant:"outlined",color:"secondary",onChange:c})})})})]})}),e.jsx("div",{className:"circle-shadow absolute opacity-[23%] -top-[10%] -left-[50%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:C,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow absolute opacity-[25%] top-[40%] -right-[20%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:C,alt:"circle-shadow"})})]}),e.jsx(I,{})]})}function Ye(){const{pathname:a}=b(),t=W.filter(({link:r})=>r===a.slice(6));return e.jsxs(e.Fragment,{children:[e.jsx(A,{}),e.jsx("section",{className:"single-blog relative pt-16f pt-24 sm:pt-20 pb-28 sm:pb-44 overflow-hidden",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"flex justify-center items-center blog-content",children:e.jsx("div",{className:"blog-img p-[0.03rem] rounded-md",children:e.jsx("img",{className:"rounded-md",src:"",alt:t.alt})})}),e.jsxs("div",{className:"blog-content ",children:[e.jsx("div",{className:"heading",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.9rem] tracking-tight text-wht-gradient",children:t[0].title})}),e.jsxs("div",{className:"blog-wrap-data global-shadow",children:[e.jsx("div",{className:"data ",dangerouslySetInnerHTML:{__html:t[0].data}}),e.jsx("div",{className:"btn mt-10 m-auto max-w-[17rem]",children:e.jsx(o,{to:"/waitinglist",className:"uppercase font-Montserrat text-sm font-semibold  transition-all duration-200 glowing-btn",children:"Join The Waitlist"})})]})]})]})})}),e.jsx(I,{})]})}document.addEventListener("contextmenu",a=>a.preventDefault());function R(a,t){return a.ctrlKey&&a.shiftKey&&a.keyCode===t.charCodeAt(0)}document.onkeydown=a=>{if(event.keyCode===123||R(a,"I")||R(a,"J")||R(a,"C")||a.ctrlKey&&a.keyCode==="U".charCodeAt(0))return!1};function Ge(){return e.jsxs("div",{className:"App body-background",children:[e.jsx(_,{children:e.jsxs(ee,{children:[e.jsx(v,{path:"/",element:e.jsx(Pe,{})}),e.jsx(v,{path:"login",element:e.jsx(Le,{})}),e.jsx(v,{path:"faq",element:e.jsx(Oe,{})}),e.jsx(v,{path:"cookie-policy",element:e.jsx(De,{})}),e.jsx(v,{path:"privacy-policy",element:e.jsx(Re,{})}),e.jsx(v,{path:"terms-condition",element:e.jsx(qe,{})}),e.jsx(v,{path:"risk-disclosure",element:e.jsx($e,{})}),e.jsx(v,{path:"blog",element:e.jsx(Ve,{})}),e.jsx(v,{path:"blog/:blog",element:e.jsx(Ye,{})}),e.jsx(v,{path:"/waitinglist",element:e.jsx(Be,{})})]})}),e.jsx(ze,{})]})}J.createRoot(document.getElementById("root")).render(e.jsx(K.StrictMode,{children:e.jsx(Ge,{})}));
