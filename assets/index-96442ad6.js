...
`},{link:"blog-5",img:"",title:"Introduction to Forex Trading with The Funded Hub: A Beginner's Guide",para:`<span></span> Explore the power of leverage
          ...
          `},{link:"blog-12",img:"",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function Ge(){let[a,t]=i.useState(1);const r=6,n=Math.ceil($.length/r),s=Ye($,r),c=(h,u)=>{t(u),s.jump(u)},d=le({palette:{mode:"dark"}});return e.jsxs(e.Fragment,{children:[e.jsx(F,{}),e.jsxs("section",{className:"blog relative fpt-32 pt-36 sm:pt-48 pb-28 sm:pb-44 overflow-hidden",children:[e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"header flex justify-between w-full",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.7rem] tracking-tight text-wht-gradient",children:"Blog"})}),e.jsx("div",{className:"blogs mt-12 grid sm:grid-cols-2 md:grid-cols-3 gap-6 relative",children:s.currentData().map((h,u)=>e.jsxs(l,{to:`/blog/${h.link}`,className:"single-blog p-[0.9rem] bg-light/20 backdrop-blur-3xl rounded-xl !relative global-shadow grid justify-between items-end gap-4",children:[e.jsx("div",{className:"blog-img rounded-md hidden",children:e.jsx("img",{className:"rounded-md w-full h-full leading-none",src:h.img,alt:h.alt})}),e.jsxs("div",{className:"texts fmt-6 grid gap-3 pb-8",children:[e.jsx("h3",{className:"font-semibold",children:h.title}),e.jsx("div",{className:"blog-para-slice",children:e.jsx("p",{dangerouslySetInnerHTML:{__html:h.para.slice(0,140)+"...."}})}),e.jsx("div",{className:"date text-sm absolute bottom-3",children:h.date})]})]},h.title+u))}),e.jsx("div",{className:"pagination mt-10 flex justify-center",children:e.jsx(ce,{theme:d,children:e.jsx(de,{spacing:2,children:e.jsx(he,{count:n,page:a,shape:"rounded",variant:"outlined",color:"secondary",onChange:c})})})})]})}),e.jsx("div",{className:"circle-shadow absolute opacity-[23%] -top-[10%] -left-[50%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:w,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow absolute opacity-[25%] top-[40%] -right-[20%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:w,alt:"circle-shadow"})})]}),e.jsx(C,{})]})}function Ke(){const{pathname:a}=j(),t=$.filter(({link:r})=>r===a.slice(6));return e.jsxs(e.Fragment,{children:[e.jsx(F,{}),e.jsx("section",{className:"single-blog relative pt-16f pt-24 sm:pt-20 pb-28 sm:pb-44 overflow-hidden",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"flex justify-center items-center blog-content",children:e.jsx("div",{className:"blog-img p-[0.03rem] rounded-md",children:e.jsx("img",{className:"rounded-md",src:"",alt:t.alt})})}),e.jsxs("div",{className:"blog-content ",children:[e.jsx("div",{className:"heading",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.9rem] tracking-tight text-wht-gradient",children:t[0].title})}),e.jsxs("div",{className:"blog-wrap-data global-shadow",children:[e.jsx("div",{className:"data ",dangerouslySetInnerHTML:{__html:t[0].data}}),e.jsx("div",{className:"btn mt-10 m-auto max-w-[17rem]",children:e.jsx(l,{to:"/waitinglist",className:"uppercase font-Montserrat text-sm font-semibold  transition-all duration-200 glowing-btn",children:"Join The Waitlist"})})]})]})]})})}),e.jsx(C,{})]})}function Je(){return e.jsx("div",{className:"App body-background",children:e.jsx(_,{children:e.jsxs(ee,{children:[e.jsx(b,{path:"/",element:e.jsx(He,{})}),e.jsx(b,{path:"login",element:e.jsx(Oe,{})}),e.jsx(b,{path:"contact",element:e.jsx(Me,{})}),e.jsx(b,{path:"report-problem",element:e.jsx(De,{})}),e.jsx(b,{path:"faq",element:e.jsx(qe,{})}),e.jsx(b,{path:"cookie-policy",element:e.jsx($e,{})}),e.jsx(b,{path:"privacy-policy",element:e.jsx(We,{})}),e.jsx(b,{path:"terms-condition",element:e.jsx(ze,{})}),e.jsx(b,{path:"risk-disclosure",element:e.jsx(Be,{})}),e.jsx(b,{path:"blog",element:e.jsx(Ge,{})}),e.jsx(b,{path:"blog/:blog",element:e.jsx(Ke,{})}),e.jsx(b,{path:"/waitinglist",element:e.jsx(Ve,{})})]})})})}J.createRoot(document.getElementById("root")).render(e.jsx(K.StrictMode,{children:e.jsx(Je,{})}));
