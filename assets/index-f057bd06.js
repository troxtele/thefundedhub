...
`},{link:"blog-5",title:"Introduction to Forex Trading with The Funded Hub: A Beginner&apos;s Guide",para:`<span>Meta Description:</span> Explore the power of leverage
          ...
          `},{link:"blog-12",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function ht(){const{pathname:a}=T(),t=ct.filter(({link:i})=>i===a.slice(6));return e.jsxs(e.Fragment,{children:[e.jsx(E,{}),e.jsx("section",{className:"single-blog relative pt-32 sm:pt-48 pb-28 sm:pb-44 purple-shadow",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"flex justify-center items-center",children:e.jsx("div",{className:"blog-img p-[0.03rem] rounded-md",children:e.jsx("img",{className:"rounded-md",src:ue,alt:""})})}),e.jsxs("div",{className:"blog-content",children:[e.jsx("div",{className:"heading",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.9rem] tracking-tight text-wht-gradient",children:t[0].title})}),e.jsxs("div",{className:"blog-wrap-data",children:[e.jsx("div",{className:"data",dangerouslySetInnerHTML:{__html:t[0].data}}),e.jsx("div",{className:"btn mt-10 m-auto max-w-[17rem]",children:e.jsx(h,{to:"/",className:"uppercase font-Montserrat text-sm font-semibold  transition-all duration-200 glowing-btn",children:"Get Funded now"})})]})]})]})})}),e.jsx(D,{})]})}function mt(){return e.jsx("div",{className:"App",children:e.jsx(xe,{children:e.jsxs(je,{children:[e.jsx(b,{path:"/",element:e.jsx(Ta,{})}),e.jsx(b,{path:"login",element:e.jsx(Ca,{})}),e.jsx(b,{path:"contact",element:e.jsx(Pa,{})}),e.jsx(b,{path:"faq",element:e.jsx(Aa,{})}),e.jsx(b,{path:"checkout",element:e.jsx(ot,{})}),e.jsx(b,{path:"cookie-policy",element:e.jsx(Fa,{})}),e.jsx(b,{path:"privacy-policy",element:e.jsx(Ma,{})}),e.jsx(b,{path:"terms-condition",element:e.jsx(Ea,{})}),e.jsx(b,{path:"risk-disclosure",element:e.jsx(Da,{})}),e.jsx(b,{path:"report-problem",element:e.jsx(Ba,{})}),e.jsx(b,{path:"blog",element:e.jsx(dt,{})}),e.jsx(b,{path:"blog/:blog",element:e.jsx(ht,{})}),e.jsxs(b,{path:"dashboard",element:e.jsx(Wa,{}),children:[e.jsx(b,{path:"Profile",element:e.jsx(Va,{})}),e.jsx(b,{path:"billing",element:e.jsx(Ja,{})}),e.jsx(b,{path:"start-new-challenge",element:e.jsx(Xa,{})}),e.jsx(b,{path:"withdraw",element:e.jsx($a,{})}),e.jsx(b,{path:"top-up-reset",element:e.jsx(Ya,{})}),e.jsx(b,{path:"help",element:e.jsx(Ga,{})}),e.jsx(b,{path:"dashboard-contact",element:e.jsx(_a,{})}),e.jsx(b,{path:"certificate",element:e.jsx(it,{})})]})]})})})}ge.createRoot(document.getElementById("root")).render(e.jsx(fe.StrictMode,{children:e.jsx(mt,{})}));
