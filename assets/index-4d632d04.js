...
`},{link:"blog-5",title:"Introduction to Forex Trading with The Funded Hub: A Beginner's Guide",para:`<span>Meta Description:</span> Explore the power of leverage
          ...
          `},{link:"blog-12",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function st(){let[t,a]=i.useState(1);const s=6,r=Math.ceil(q.length/s),o=tt(q,s),l=(c,p)=>{a(p),o.jump(p)},d=Ke({palette:{mode:"dark"}});return e.jsxs(e.Fragment,{children:[e.jsx(A,{}),e.jsx("section",{className:"blog bg-dark relative pt-32 sm:pt-48 pb-28 sm:pb-44 purple-shadow",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"header flex justify-between w-full",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.7rem] tracking-tight text-wht-gradient",children:"Blog"})}),e.jsx("div",{className:"blogs mt-12 grid sm:grid-cols-2 md:grid-cols-3 gap-6 relative",children:o.currentData().map((c,p)=>e.jsxs(m,{to:`/blog/${c.link}`,className:"single-blog p-[0.9rem] bg-light/20 backdrop-blur-3xl rounded-xl !relative global-shadow",children:[e.jsx("div",{className:"blog-img rounded-md",children:e.jsx("img",{className:"rounded-md w-full h-full leading-none hidden",src:"",alt:""})}),e.jsxs("div",{className:"texts fmt-6 grid gap-3 pb-8",children:[e.jsx("h3",{className:"font-semibold",children:c.title}),e.jsx("div",{className:"blog-para-slice",children:e.jsx("p",{dangerouslySetInnerHTML:{__html:c.para.slice(0,140)+"...."}})}),e.jsx("div",{className:"date text-sm absolute bottom-3",children:c.date})]})]},c.title+p))}),e.jsx("div",{className:"pagination mt-10 flex justify-center",children:e.jsx(Qe,{theme:d,children:e.jsx(_e,{spacing:2,children:e.jsx(Ze,{count:r,page:t,shape:"rounded",variant:"outlined",color:"secondary",onChange:l})})})})]})})}),e.jsx(P,{})]})}function it(){const{pathname:t}=w(),a=q.filter(({link:s})=>s===t.slice(6));return e.jsxs(e.Fragment,{children:[e.jsx(A,{}),e.jsx("section",{className:"single-blog bg-dark relative pt-32 sm:pt-48 pb-28 sm:pb-44 purple-shadow",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"flex justify-center items-center",children:e.jsx("div",{className:"blog-img p-[0.03rem] rounded-md hidden",children:e.jsx("img",{className:"rounded-md",src:ce,alt:""})})}),e.jsxs("div",{className:"blog-content global-shadow ",children:[e.jsx("div",{className:"heading",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.9rem] tracking-tight text-wht-gradient",children:a[0].title})}),e.jsxs("div",{className:"blog-wrap-data",children:[e.jsx("div",{className:"data",dangerouslySetInnerHTML:{__html:a[0].data}}),e.jsx("div",{className:"btn mt-10 m-auto max-w-[17rem]",children:e.jsx(m,{to:"/",className:"uppercase font-Montserrat text-sm font-semibold  transition-all duration-200 glowing-btn",children:"Get Funded now"})})]})]})]})})}),e.jsx(P,{})]})}function rt(){return e.jsxs("div",{className:"App",children:[e.jsx(pe,{children:e.jsxs(fe,{children:[e.jsx(y,{path:"/",element:e.jsx(ba,{})}),e.jsx(y,{path:"login",element:e.jsx(wa,{})}),e.jsx(y,{path:"contact",element:e.jsx(Na,{})}),e.jsx(y,{path:"faq",element:e.jsx(Ta,{})}),e.jsx(y,{path:"cookie-policy",element:e.jsx(Sa,{})}),e.jsx(y,{path:"privacy-policy",element:e.jsx(Aa,{})}),e.jsx(y,{path:"terms-condition",element:e.jsx(Pa,{})}),e.jsx(y,{path:"risk-disclosure",element:e.jsx(Ca,{})}),e.jsx(y,{path:"report-problem",element:e.jsx(Ma,{})}),e.jsx(y,{path:"blog",element:e.jsx(st,{})}),e.jsx(y,{path:"blog/:blog",element:e.jsx(it,{})}),e.jsxs(y,{path:"dashboard",element:e.jsx(Ra,{}),children:[e.jsx(y,{path:"Profile",element:e.jsx($a,{})}),e.jsx(y,{path:"billing",element:e.jsx(Wa,{})}),e.jsx(y,{path:"start-new-challenge",element:e.jsx(qa,{})}),e.jsx(y,{path:"withdraw",element:e.jsx(Ua,{})}),e.jsx(y,{path:"top-up-reset",element:e.jsx(za,{})}),e.jsx(y,{path:"certificate",element:e.jsx(_a,{})})]}),e.jsx(y,{path:"thank-you",element:e.jsx(Za,{})}),e.jsx(y,{path:"payment-error",element:e.jsx(et,{})})]})}),e.jsx(at,{})]})}me.createRoot(document.getElementById("root")).render(e.jsx(he.StrictMode,{children:e.jsx(rt,{})}));
