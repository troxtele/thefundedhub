...
`},{link:"blog-5",title:"Introduction to Forex Trading with The Funded Hub: A Beginner&apos;s Guide",para:`<span>Meta Description:</span> Explore the power of leverage
          ...
          `},{link:"blog-12",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function rt(){let[t,a]=s.useState(1);const i=6,r=Math.ceil(te.length/i),n=st(te,i),l=(h,p)=>{a(p),n.jump(p)},o=Ke({palette:{mode:"dark"}});return e.jsxs(e.Fragment,{children:[e.jsx(M,{}),e.jsx("section",{className:"blog relative pt-32 sm:pt-48 pb-28 sm:pb-44 purple-shadow",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"header flex justify-between w-full",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.7rem] tracking-tight text-wht-gradient",children:"Blog"})}),e.jsx("div",{className:"blogs mt-12 grid sm:grid-cols-2 md:grid-cols-3 gap-6 relative",children:n.currentData().map((h,p)=>e.jsxs(c,{to:`/blog/${h.link}`,className:"single-blog p-[0.9rem] bg-light/20 backdrop-blur-3xl rounded-xl !relative",children:[e.jsx("div",{className:"blog-img rounded-md",children:e.jsx("img",{className:"rounded-md w-full h-full leading-none hidden",src:"",alt:""})}),e.jsxs("div",{className:"texts fmt-6 grid gap-3 pb-8",children:[e.jsx("h3",{className:"font-semibold",children:h.title}),e.jsx("div",{className:"blog-para-slice",children:e.jsx("p",{dangerouslySetInnerHTML:{__html:h.para.slice(0,140)+"...."}})}),e.jsx("div",{className:"date text-sm absolute bottom-3",children:h.date})]})]},h.title+p))}),e.jsx("div",{className:"pagination mt-10 flex justify-center",children:e.jsx(Qe,{theme:o,children:e.jsx(Ze,{spacing:2,children:e.jsx(ea,{count:r,page:t,shape:"rounded",variant:"outlined",color:"secondary",onChange:l})})})})]})})}),e.jsx(E,{})]})}const nt=[{link:"blog-1",title:"Leveraging Leverage: A Guide for Forex Traders",date:"26 August 2023",para:`<span>Meta Description:</span> Explore the power of leverage
                  in forex trading and how it can magnify your potential gains
                  and losses. Discover how to use leverage wisely with valuable
                  insights throughout the post. Forex trading offers an
                  incredible opportunity for traders to capitalize on currency
...
`},{link:"blog-5",title:"Introduction to Forex Trading with The Funded Hub: A Beginner&apos;s Guide",para:`<span>Meta Description:</span> Explore the power of leverage
          ...
          `},{link:"blog-12",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function ot(){const{pathname:t}=b(),a=nt.filter(({link:i})=>i===t.slice(6));return e.jsxs(e.Fragment,{children:[e.jsx(M,{}),e.jsx("section",{className:"single-blog relative pt-32 sm:pt-48 pb-28 sm:pb-44 purple-shadow",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"flex justify-center items-center",children:e.jsx("div",{className:"blog-img p-[0.03rem] rounded-md",children:e.jsx("img",{className:"rounded-md",src:pe,alt:""})})}),e.jsxs("div",{className:"blog-content",children:[e.jsx("div",{className:"heading",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.9rem] tracking-tight text-wht-gradient",children:a[0].title})}),e.jsxs("div",{className:"blog-wrap-data",children:[e.jsx("div",{className:"data",dangerouslySetInnerHTML:{__html:a[0].data}}),e.jsx("div",{className:"btn mt-10 m-auto max-w-[17rem]",children:e.jsx(c,{to:"/",className:"uppercase font-Montserrat text-sm font-semibold  transition-all duration-200 glowing-btn",children:"Get Funded now"})})]})]})]})})}),e.jsx(E,{})]})}function lt(){return e.jsxs("div",{className:"App",children:[e.jsx(fe,{children:e.jsxs(ve,{children:[e.jsx(x,{path:"/",element:e.jsx(wa,{})}),e.jsx(x,{path:"login",element:e.jsx(ka,{})}),e.jsx(x,{path:"contact",element:e.jsx(Ta,{})}),e.jsx(x,{path:"faq",element:e.jsx(Sa,{})}),e.jsx(x,{path:"cookie-policy",element:e.jsx(Ca,{})}),e.jsx(x,{path:"privacy-policy",element:e.jsx(Pa,{})}),e.jsx(x,{path:"terms-condition",element:e.jsx(Aa,{})}),e.jsx(x,{path:"risk-disclosure",element:e.jsx(Fa,{})}),e.jsx(x,{path:"report-problem",element:e.jsx(Ma,{})}),e.jsx(x,{path:"blog",element:e.jsx(rt,{})}),e.jsx(x,{path:"blog/:blog",element:e.jsx(ot,{})}),e.jsxs(x,{path:"dashboard",element:e.jsx(Ua,{}),children:[e.jsx(x,{path:"Profile",element:e.jsx($a,{})}),e.jsx(x,{path:"billing",element:e.jsx(Ga,{})}),e.jsx(x,{path:"start-new-challenge",element:e.jsx(Va,{})}),e.jsx(x,{path:"withdraw",element:e.jsx(La,{})}),e.jsx(x,{path:"top-up-reset",element:e.jsx(qa,{})}),e.jsx(x,{path:"help",element:e.jsx(Wa,{})}),e.jsx(x,{path:"dashboard-contact",element:e.jsx(Ya,{})}),e.jsx(x,{path:"certificate",element:e.jsx(et,{})})]}),e.jsx(x,{path:"thank-you",element:e.jsx(at,{})}),e.jsx(x,{path:"payment-error",element:e.jsx(tt,{})})]})}),e.jsx(it,{})]})}ue.createRoot(document.getElementById("root")).render(e.jsx(me.StrictMode,{children:e.jsx(lt,{})}));
