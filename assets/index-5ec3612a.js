import{r,j as e,a as ne}from"./react-91cb21d0.js";import{c as oe}from"./react-dom-9e346b82.js";import{L as f,B as le}from"./react-router-dom-9903efd0.js";import{R as ee}from"./react-ga-80b12757.js";import{a as q}from"./axios-21b846bc.js";import{S as de,N as ce,a as z}from"./swiper-2ebe8f0c.js";import{R as he}from"./react-icons-5a48aa7c.js";import{b as k,d as ue,e as pe,f as v}from"./react-router-b395eb81.js";import{P as K}from"./prop-types-834188aa.js";import{c as me,T as fe,S as ge,P as ye}from"./@mui-c709a2db.js";import"./hoist-non-react-statics-f84d2b88.js";import"./scheduler-765c72db.js";import"./@remix-run-d753ad9e.js";import"./ssr-window-c9202916.js";import"./@babel-5d790daf.js";import"./clsx-1229b3e0.js";import"./@emotion-f85709ee.js";import"./stylis-79144faa.js";import"./react-transition-group-4b2cab63.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const d of s)if(d.type==="childList")for(const h of d.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&o(h)}).observe(document,{childList:!0,subtree:!0});function n(s){const d={};return s.integrity&&(d.integrity=s.integrity),s.referrerPolicy&&(d.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?d.credentials="include":s.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function o(s){if(s.ep)return;s.ep=!0;const d=n(s);fetch(s.href,d)}})();const R="/assets/logo-f6759efc.webp",b="/assets/arrow-cfc95aca.svg",T="/assets/circle-56f758db.webp",I="/assets/half-circle-d6403a1d.webp",_="/assets/meta-trader-5-ec51858e.webp",J="/assets/meta-trader-4-873c0a4f.webp";function xe(){const[a,i]=r.useState(!1),[n,o]=r.useState(),[s,d]=r.useState(""),[h,m]=r.useState(""),[u,y]=r.useState(!0),[x,C]=r.useState(!0),[A,P]=r.useState(!1);r.useEffect(()=>{/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(n)&&n!==""?C(!0):A&&C(!1)},[n,u]);const[t,g]=r.useState("100000"),[N,E]=r.useState("0"),[S,L]=r.useState("5"),[F,O]=r.useState("5"),[p,U]=r.useState("10"),[W,V]=r.useState("8"),[M,ie]=r.useState(0),[D,Y]=r.useState("meta-5"),l={5e3:{maxDailyLossVal:["$ 250 (5%)","$ 200 (4%)"],maxOverallLossVal:["$ 600 (12%)","$ 500 (10%)","$ 400 (8%)"],profitTargetVal:["$ 500 (10%)","$ 400 (8%)","$ 250 (5%)"],monthlySalaryVal:["$ 50.00/Month"]},1e4:{maxDailyLossVal:["$ 500 (5%)","$ 400 (4%)"],maxOverallLossVal:["$ 1,200 (12%)","$ 1,000 (10%)","$ 800 (8%)"],profitTargetVal:["$ 1,000 (10%)","$ 800 (8%)","$ 500 (5%)"],monthlySalaryVal:["$ 100.00/Month"]},25e3:{maxDailyLossVal:["$ 1,250 (5%)","$ 1,000 (4%)"],maxOverallLossVal:["$ 3,000 (12%)","$ 2,500 (10%)","$ 2,000 (8%)"],profitTargetVal:["$ 2,500 (10%)","$ 2,000 (8%)","$ 1,250 (5%)"],monthlySalaryVal:["$ 250.00/Month"]},5e4:{maxDailyLossVal:["$ 2,500 (5%)","$ 2,000 (4%)"],maxOverallLossVal:["$ 6,000 (12%)","$ 5,000 (10%)","$ 4,000 (8%)"],profitTargetVal:["$ 5,000 (10%)","$ 4,000 (8%)","$ 2,500 (5%)"],monthlySalaryVal:["$ 500.00/Month"]},1e5:{maxDailyLossVal:["$ 5,000 (5%)","$ 4,000 (4%)"],maxOverallLossVal:["$ 12,000 (12%)","$ 10,000 (10%)","$ 8,000 (8%)"],profitTargetVal:["$ 10,000 (10%)","$ 8,000 (8%)","$ 5,000 (5%)"],monthlySalaryVal:["$ 1000.00/Month"]},2e5:{maxDailyLossVal:["$ 10,000 (5%)","$ 8,000 (4%)"],maxOverallLossVal:["$ 24,000 (12%)","$ 20,000 (10%)","$ 16,000 (8%)"],profitTargetVal:["$ 20,000 (10%)","$ 16,000 (8%)","$ 10,000 (5%)"],monthlySalaryVal:["$ 2000.00/Month"]}},G="https://development-api.thefundedhub.com";r.useEffect(()=>{const c=`${G}/v1/website/prices?startingCapital=${t}&phase1MaximumTradingDays=${N}&phase1MinimumTradingDays=${S}&phase1ProfitTargetPercentage=${W}&phase1MaximumDailyLossPercentage=${F}&phase1MaximumTotalLossPercentage=${p}`;q.get(c).then(H=>{ie(H.data.data.totalPrice)}).catch(H=>{console.error("There was an error!",H)})},[t,F,p,W,S,N]);const re=()=>{q.post(`${G}/v1/website/purchases`,{voucherCode:"string",email:n,firstName:s,lastName:h,paymentProvider:"STRIPE",platform:"MT5",startingCapital:t,phase1MaximumTradingDays:N,phase1MinimumTradingDays:S,phase1ProfitTargetPercentage:W,phase1MaximumDailyLossPercentage:F,phase1MaximumTotalLossPercentage:p}).then(c=>{const H=c.data.data;localStorage.setItem("purchaseUuid",H.uuid),window.location.replace(c.data.data.paymentUrl)})};r.useEffect(()=>{/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(n)&&n!==""?C(!0):A&&C(!1)},[n,u]);const se=c=>{c.preventDefault(),y(!1),s&&h&&x?re():P(!0)};return e.jsxs(e.Fragment,{children:[e.jsxs("div",{id:"price-table",className:"price-table relative z-50 before:absolute before:h-36 before:w-full before:z-10",children:[e.jsxs("div",{className:"desktop-content relative z-[999] hidden lg:grid gap-2 w-full backdrop-blur-3xl rounded-2xl font-Montserrat",children:[e.jsxs("div",{className:"left grid grid-cols-5 items-center justify-start gap-2  font-medium relative",children:[e.jsx("div",{className:"price-table-border relative grid col-span-3 gap-5 h-full rounded-3xl",children:e.jsxs("div",{className:"heading p-5 h-full grid gap-3 rounded-3xl price-table-bg relative",children:[e.jsxs("h3",{className:"font-light",children:[e.jsx("b",{className:"font-bold",children:"Step 1: "})," Choose your Balance"]}),e.jsxs("div",{className:"prices flex flex-wrap gap-4",children:[e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-[5.5rem] py-2.5 rounded-mds border-b-2 leading-[0.7] ${t==="5000"?"border-primary":"border-primary/10"}`,onClick:()=>g("5000"),children:"$ 5,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-[5.5rem] py-2.5 rounded-mds border-b-2 leading-[0.7] ${t==="10000"?"border-primary":"border-primary/10"}`,onClick:()=>g("10000"),children:"$ 10,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-[5.5rem] py-2.5 rounded-mds border-b-2 leading-[0.7] ${t==="25000"?"border-primary":"border-primary/10"}`,onClick:()=>g("25000"),children:"$ 25,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-[5.5rem] py-2.5 rounded-mds border-b-2 leading-[0.7] ${t==="50000"?"border-primary":"border-primary/10"}`,onClick:()=>g("50000"),children:"$ 50,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-[5.5rem] py-2.5 rounded-mds border-b-2 leading-[0.7] ${t==="100000"?"border-primary":"border-primary/10"}`,onClick:()=>g("100000"),children:"$ 100,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-[5.5rem] py-2.5 rounded-mds border-b-2 leading-[0.7] ${t==="200000"?"border-primary":"border-primary/10"}`,onClick:()=>g("200000"),children:"$ 200,000"})})]})]})}),e.jsx("div",{className:"price-table-border col-span-2 relative",children:e.jsxs("div",{className:"right-inside p-5 rounded-3xl h-full price-table-bg",children:[e.jsx("div",{className:"heading",children:e.jsxs("h3",{className:"font-light",children:[e.jsx("b",{className:"font-bold",children:"Step 2: "})," Choose your Platform"]})}),e.jsxs("div",{className:"tranders flex gap-3 items-center w-full mt-2 relative z-30",children:[e.jsxs("div",{className:`img scale-105 transition-all duration-200 py-2 px-6 rounded-3xl bg-light/30 relative group ${D==="meta-4"?"border-primary":"border-transparent "}`,children:[e.jsx("img",{className:"max-w-[7rem] w-full relative opacity-20",src:J,alt:"scop-markets"}),e.jsx("div",{className:"coming-soon absolute transition-all duration-200 opacity-0 group-hover:opacity-100 left-1/2 transform -translate-x-1/2 whitespace-nowrap -bottom-[1rem]",children:e.jsx("h6",{className:"text-[0.65rem]",children:"Available Soon!"})})]}),e.jsx("div",{className:`img scale-100 hover:scale-105 transition-all duration-200 py-2 px-6 rounded-3xl bg-light/60 border hover:border-primary cursor-pointer ${D==="meta-5"?"border-primary":"border-transparent "}`,onClick:()=>Y("meta-5"),children:e.jsx("img",{className:"max-w-[7rem] w-full opacity-[0.87]",src:_,alt:"meta-trader-5"})})]})]})})]}),e.jsx("div",{className:"price-table-border relative",children:e.jsxs("div",{className:"grid rounded-3xl w-full p-7 price-table-bg",children:[e.jsx("div",{className:"heading mb-8",children:e.jsxs("h3",{children:[e.jsx("b",{className:"font-bold",children:"Step 3:"})," Customize your Challenge"]})}),e.jsxs("div",{className:"item grid grid-cols-10 gap-6 px-4 py-3 border-b border-primary/10 text-center relative z-[50]",children:[e.jsxs("span",{className:"col-span-4 text-start flex items-center gap-1",children:["Trading ",e.jsx("b",{className:"font-bold",children:" Period "}),":"]}),e.jsx("div",{className:"col-span-2 relative before:absolute before:font-bold before:content-['Phase_1'] flex justify-center before:-top-10 before:text-[0.9rem] whitespace-nowrap !font-normal",children:e.jsxs("div",{className:"wrap relative",children:[e.jsxs("select",{id:"treading-period",name:"treading-period",onChange:c=>E(c.target.value),className:"price-table-select",children:[e.jsx("option",{value:"0",children:"Unlimited"}),e.jsx("option",{value:"45",children:"45 Days"}),e.jsx("option",{value:"30",children:"30 Days"})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:b,alt:"arrow"})})]})}),e.jsx("div",{className:"col-span-2 flex justify-center",children:e.jsx("div",{className:"relative before:absolute before:font-bold before:content-['Phase_2'] flex justify-center before:-top-10 before:text-[0.9rem] font-normal whitespace-nowrap",children:e.jsx("div",{className:"col-span-2 flex justify-center items-center",children:e.jsx("span",{className:"priceVal",children:N==="0"?"Unlimited":N==="45"?"45 Days":"60 Days"})})})}),e.jsx("span",{className:"col-span-2 relative before:absolute before:font-bold before:content-['Funded'] before:-top-10 flex justify-center items-center",children:"Unlimited"})]}),e.jsxs("div",{className:"item grid grid-cols-10 gap-6 px-4 py-3 border-b border-primary/10 text-center relative z-40",children:[e.jsxs("span",{className:"col-span-4 text-start flex items-center gap-1",children:["Minimum Trading ",e.jsx("b",{className:"font-bold",children:" Days"}),":"]}),e.jsx("span",{className:"col-span-2 flex justify-center ",children:e.jsxs("div",{className:"wrap relative",children:[e.jsxs("select",{id:"treading-period",name:"treading-period",onChange:c=>L(c.target.value),className:"price-table-select",children:[e.jsx("option",{value:"0",children:"0 Days"}),e.jsx("option",{value:"3",children:"3 Days"}),e.jsx("option",{selected:!0,value:"5",children:"5 Days"})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:b,alt:"arrow"})})]})}),e.jsx("span",{className:"col-span-2 flex justify-center",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:S==="0"?"0 Days":S==="3"?"3 Days":"5 Days"})}),e.jsx("span",{className:"col-span-2 flex justify-center items-center",children:"-"})]}),e.jsxs("div",{className:"item grid grid-cols-10 gap-6 px-4 py-3 border-b border-primary/10 text-center relative z-30",children:[e.jsxs("span",{className:"col-span-4 text-start mt-[0.13rem] flex items-center gap-1",children:["Max ",e.jsx("b",{className:"font-bold",children:" Daily "})," Loss:"]}),e.jsx("div",{className:"col-span-2 ",children:e.jsxs("span",{className:"priceVal inline-flex justify-center items-center relative",children:[e.jsxs("select",{id:"daily-loss",name:"daily-loss",onChange:c=>O(c.target.value),className:"price-table-select",children:[e.jsx("option",{value:"4",children:l[t].maxDailyLossVal[1]}),e.jsx("option",{selected:!0,value:"5",children:l[t].maxDailyLossVal[0]})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:b,alt:"arrow"})})]})}),e.jsx("div",{className:"col-span-2 flex justify-center items-center",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:F==="5"?l[t].maxDailyLossVal[0]:l[t].maxDailyLossVal[1]})}),e.jsx("div",{className:"col-span-2 flex justify-center items-center gap-1",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:F==="5"?l[t].maxDailyLossVal[0]:l[t].maxDailyLossVal[1]})})]}),e.jsxs("div",{className:"item grid grid-cols-10 gap-6 px-4 py-3 border-b border-primary/10 text-center relative z-20 ",children:[e.jsxs("span",{className:"col-span-4 text-start pt-[0.1rem] flex items-center gap-1",children:["Max ",e.jsx("b",{className:"font-bold",children:"Overall "})," Loss:"]}),e.jsx("div",{className:"col-span-2",children:e.jsxs("span",{className:"priceVal inline-flex justify-center items-center relative",children:[e.jsxs("select",{id:"daily-loss",name:"daily-loss",onChange:c=>U(c.target.value),className:"price-table-select",children:[e.jsx("option",{value:"8",children:l[t].maxOverallLossVal[2]}),e.jsx("option",{selected:!0,value:"10",children:l[t].maxOverallLossVal[1]}),e.jsx("option",{value:"12",children:l[t].maxOverallLossVal[0]})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:b,alt:"arrow"})})]})}),e.jsx("div",{className:"col-span-2 flex justify-center items-center",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:e.jsx("span",{children:p==="12"?l[t].maxOverallLossVal[0]:p==="10"?l[t].maxOverallLossVal[1]:l[t].maxOverallLossVal[2]})})}),e.jsx("div",{className:"col-span-2 flex justify-center items-center gap-1",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:p==="12"?l[t].maxOverallLossVal[0]:p==="10"?l[t].maxOverallLossVal[1]:l[t].maxOverallLossVal[2]})})]}),e.jsxs("div",{className:"item grid grid-cols-10 gap-6 px-4 py-3 border-b border-primary/10 text-center relative z-10",children:[e.jsxs("span",{className:"col-span-4 text-start mt-[0.13rem] flex items-center gap-1",children:["Profit ",e.jsx("b",{className:"font-bold",children:"Target"}),":"]}),e.jsx("div",{className:"col-span-2",children:e.jsxs("span",{className:"priceVal inline-flex justify-center items-center relative",children:[e.jsxs("select",{id:"daily-loss",name:"daily-loss",onChange:c=>V(c.target.value),className:"price-table-select",children:[e.jsx("option",{value:"8",children:l[t].profitTargetVal[1]}),e.jsx("option",{value:"10",children:l[t].profitTargetVal[0]})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:b,alt:"arrow"})})]})}),e.jsx("div",{className:"col-span-2 flex justify-center items-center gap-1",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:l[t].profitTargetVal[2]})}),e.jsx("span",{className:"col-span-2 flex justify-center items-center",children:"-"})]}),e.jsxs("div",{className:"item grid grid-cols-10 gap-6 px-4 py-3 border-b border-primary/10 text-center relative z-[5]",children:[e.jsx("span",{className:"col-span-4 text-start mt-[0.13rem]",children:"Leverage:"}),e.jsx("div",{className:"col-span-2",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:"1:100"})}),e.jsx("div",{className:"col-span-2",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:"1:100"})}),e.jsx("div",{className:"col-span-2",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:"1:100"})})]}),e.jsxs("div",{className:"item grid grid-cols-10 gap-6 px-4 py-3 border-b border-primary/10 text-center relative z-[0]",children:[e.jsxs("span",{className:"col-span-4 text-start mt-[0.13rem]",children:["Monthly ",e.jsx("b",{className:"font-bold",children:"Salary"}),":"]}),e.jsx("div",{className:"col-span-2",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:"-"})}),e.jsx("div",{className:"col-span-2",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:"-"})}),e.jsx("div",{className:"col-span-2",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:l[t].monthlySalaryVal[0]})})]})]})}),e.jsx("div",{className:"price-table-border relative",children:e.jsxs("div",{className:"bottom  relative flex justify-between py-7 px-12 rounded-3xl price-table-bg",children:[e.jsxs("div",{className:"wrap grid gap-1",children:[e.jsxs("div",{className:"refund flex items-center",children:[e.jsx("b",{className:"text-lg font-codePro",children:"Refundable fee:"}),e.jsxs("h4",{className:"text-[1.4rem] font-extrabold ml-4 w-28",children:["$ ",M]})]}),e.jsxs("div",{className:" font-Montserrat text-sm",children:["Or pay in 4 installments from"," ",e.jsxs("span",{className:"font-bold",children:["$",M/4]})," / Month",e.jsx("span",{className:"text-primary",children:" (coming soon)"})]})]}),e.jsx("div",{className:"btn flex justify-start items-center",children:e.jsx("div",{onClick:()=>i(!0),className:"home-glowing-btn cursor-pointer py-3 px-12 rounded-3xl uppercase font-bold",children:"Get Funded Now"})})]})})]}),e.jsxs("div",{className:"mobile-content relative z-20 lg:hidden flex flex-wrap justify-start items-center mt-2 ",children:[e.jsx("div",{className:"top font-medium w-full",children:e.jsx("div",{className:"heading flex justify-center",children:e.jsxs("div",{className:"prices grid grid-cols-3 gap-2",children:[e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-full p-3 xs:px-5 rounded-mdg text-[0.95] ex:text-base transition-all duration-300 leading-[0.7] whitespace-nowrap border rounded-full bg-light/40 relative before:absolute before:w-full before:h-full before:inset-0 before:rounded-full font-Montserrat price-btn-shadow ${t==="5000"?"border-primary":"border-primary/10"}`,onClick:()=>g("5000"),children:"$ 5,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-full p-3 xs:px-5 rounded-mdg text-[0.95] ex:text-base transition-all duration-300 leading-[0.7] whitespace-nowrap border rounded-full bg-light/40 relative before:absolute before:w-full before:h-full before:inset-0 before:rounded-full font-Montserrat price-btn-shadow ${t==="10000"?"border-primary":"border-primary/10"}`,onClick:()=>g("10000"),children:"$ 10,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-full p-3 xs:px-5 rounded-mdg text-[0.95] ex:text-base transition-all duration-300 leading-[0.7] whitespace-nowrap border rounded-full bg-light/40 relative before:absolute before:w-full before:h-full before:inset-0 before:rounded-full font-Montserrat price-btn-shadow ${t==="25000"?"border-primary":"border-primary/10"}`,onClick:()=>g("25000"),children:"$ 25,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-full p-3 xs:px-5 rounded-mdg text-[0.95] ex:text-base transition-all duration-300 leading-[0.7] whitespace-nowrap border rounded-full bg-light/40 relative before:absolute before:w-full before:h-full before:inset-0 before:rounded-full font-Montserrat price-btn-shadow ${t==="50000"?"border-primary":"border-primary/10"}`,onClick:()=>g("50000"),children:"$ 50,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-full p-3 xs:px-5 rounded-mdg text-[0.95] ex:text-base transition-all duration-300 leading-[0.7] whitespace-nowrap border rounded-full bg-light/40 relative before:absolute before:w-full before:h-full before:inset-0 before:rounded-full font-Montserrat price-btn-shadow ${t==="100000"?"border-primary":"border-primary/10"}`,onClick:()=>g("100000"),children:"$ 100,000"})}),e.jsx("div",{className:"price",children:e.jsx("button",{className:`w-full p-3 xs:px-5 rounded-mdg text-[0.95] ex:text-base transition-all duration-300 leading-[0.7] whitespace-nowrap border rounded-full bg-light/40 relative before:absolute before:w-full before:h-full before:inset-0 before:rounded-full font-Montserrat price-btn-shadow ${t==="200000"?"border-primary":"border-primary/10"}`,onClick:()=>g("200000"),children:"$ 200,000"})})]})})}),e.jsxs("div",{className:"tranders grid items-center w-full relative z-30",children:[e.jsxs("p",{className:"mt-7 ml-5 relative before:absolute before:w-2 before:h-2 before:bg-white before:left-[-1rem] before:rounded-full before:top-1/2 before:transform before:-translate-y-1/2",children:[" ",e.jsx("b",{className:"font-bold",children:"Step 2:"})," ","  ","Customize your Platform:"]}),e.jsxs("div",{className:"wrap flex justify-center gap-3 mt-4",children:[e.jsxs("div",{className:`img scale-100 hover:scale-105 transition-all duration-200 py-2 px-6 rounded-3xl bg-light/30 relative price-btn-shadow  ${D==="meta-4"?"border-primary":"border-transparent "}`,children:[e.jsx("img",{className:"max-w-[7rem] w-full opacity-[0.87]f opacity-60 price-btn-shadow",src:J,alt:"scop-markets"}),e.jsx("div",{className:"absolute transition-all duration-200  left-1/2 transform -translate-x-1/2 whitespace-nowrap -bottom-[1rem]",children:e.jsx("h6",{className:"text-[0.65rem]",children:"Available Soon!"})})]}),e.jsx("div",{className:`img transition-all duration-200 py-2 px-6 rounded-3xl bg-light/60 border hover:border-primary price-btn-shadow ${D==="meta-5"?"border-primary":"border-transparent"}`,onClick:()=>Y("meta-5"),children:e.jsx("img",{className:"max-w-[7rem] w-full opacity-[0.87]",src:_,alt:"meta-trader-5"})})]})]}),e.jsx("div",{className:"step w-full",children:e.jsxs("p",{className:"mt-10 ml-5 relative before:absolute before:w-2 before:h-2 before:bg-white before:left-[-1rem] before:rounded-full before:top-1/2 before:transform before:-translate-y-1/2",children:[" ",e.jsx("b",{className:"font-bold",children:"Step 3:"})," ","  ","Customize your Challenge:"]})}),e.jsx("div",{className:"flex flex-wrap gap-8 md:gap-12 justify-center items-center -mx-[1.5rem] px-[1.5rem] w-screen sm:w-[70vw] sm:m-auto relative z-20",children:e.jsxs(de,{navigation:!0,grabCursor:!0,centeredSlides:!0,slidesPerView:"auto",modules:[ce],spaceBetween:30,className:"flex flex-wrap gap-8 md:gap-10 justify-center items-center w-full px-3 xs:px-6 mt-4 text-white",children:[e.jsx(z,{children:e.jsxs("div",{className:"phase1 pt-2 pb-6 item grid gap-3 border border-primary/20 rounded-3xl uni-bg-gradient h-full card-shadow",children:[e.jsx("div",{className:"heading pb-3 mt-2 ",children:e.jsx("h3",{className:"px-5 text-center m-auto max-w-[10rem] border-b-2 border-primary/30 pb-3 font-codeProBold font-extrabold",children:"Phase 1"})}),e.jsxs("div",{className:"items grid gap-4 px-4",children:[e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Trading",e.jsx("b",{className:"font-bold",children:" Period"}),":"]}),e.jsx("div",{children:e.jsx("div",{className:"wrap flex gap-2 justify-center items-center relative z-[10]",children:e.jsxs("div",{className:"wrap relative",children:[e.jsxs("select",{id:"treading-period",name:"treading-period",onChange:c=>E(c.target.value),className:"price-table-select",children:[e.jsx("option",{value:"0",children:"Unlimited"}),e.jsx("option",{value:"45",children:"45 Days"}),e.jsx("option",{value:"30",children:"30 Days"})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:b,alt:"arrow"})})]})})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center relative z-[9]",children:[e.jsxs("span",{children:["Min. Trading",e.jsx("b",{className:"font-bold",children:" Days"}),":"]}),e.jsxs("div",{className:"wrap relative",children:[e.jsxs("select",{id:"treading-period",name:"treading-period",onChange:c=>L(c.target.value),className:"price-table-select",children:[e.jsx("option",{value:"0",children:"0 Days"}),e.jsx("option",{value:"3",children:"3 Days"}),e.jsx("option",{selected:!0,value:"5",children:"5 Days"})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:b,alt:"arrow"})})]})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center relative z-[8]",children:[e.jsxs("span",{children:["Max",e.jsx("b",{className:"font-bold",children:" Daily "})," Loss:"]}),e.jsx("div",{children:e.jsxs("span",{className:"priceVal inline-flex justify-center items-center relative",children:[e.jsxs("select",{id:"daily-loss",name:"daily-loss",onChange:c=>O(c.target.value),className:"price-table-select",children:[e.jsx("option",{value:"4",children:l[t].maxDailyLossVal[1]}),e.jsx("option",{selected:!0,value:"5",children:l[t].maxDailyLossVal[0]})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:b,alt:"arrow"})})]})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center relative z-[7]",children:[e.jsxs("span",{children:["Max",e.jsx("b",{className:"font-bold",children:" Overall "})," Loss:"]}),e.jsx("div",{children:e.jsxs("span",{className:"priceVal inline-flex justify-center items-center relative",children:[e.jsxs("select",{id:"daily-loss",name:"daily-loss",onChange:c=>U(c.target.value),className:"price-table-select",children:[e.jsx("option",{value:"8",children:l[t].maxOverallLossVal[2]}),e.jsx("option",{selected:!0,value:"10",children:l[t].maxOverallLossVal[1]}),e.jsx("option",{value:"12",children:l[t].maxOverallLossVal[0]})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:b,alt:"arrow"})})]})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center relative z-[6]",children:[e.jsxs("span",{children:["Profit ",e.jsx("b",{className:"font-bold",children:" Target "}),":"]}),e.jsx("div",{children:e.jsxs("span",{className:"priceVal inline-flex justify-center items-center relative",children:[e.jsxs("select",{id:"daily-loss",name:"daily-loss",onChange:c=>V(c.target.value),className:"price-table-select",children:[e.jsx("option",{value:"8",children:l[t].profitTargetVal[1]}),e.jsx("option",{value:"10",children:l[t].profitTargetVal[0]})]}),e.jsx("div",{className:"arrow absolute right-[0.55rem] top-1/2 transform -translate-y-1/2",children:e.jsx("img",{className:"w-[0.9rem]",src:b,alt:"arrow"})})]})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsx("span",{children:"Leverage:"}),e.jsx("div",{children:e.jsx("span",{className:"sm:w-[136px] flex justify-center",children:"1:100"})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Monthly ",e.jsx("b",{className:"font-bold",children:" Salary "}),":"]}),e.jsx("div",{children:e.jsx("span",{className:"sm:w-[136px] flex justify-center",children:"-"})})]})]})]})}),e.jsx(z,{children:e.jsxs("div",{className:"phase-2 pt-2 pb-6 item grid gap-3 border border-primary/20 rounded-3xl uni-bg-gradient h-full card-shadow",children:[e.jsx("div",{className:"heading pb-3 mt-2 ",children:e.jsx("h3",{className:"px-5 text-center m-auto max-w-[10rem] border-b-2 border-primary/30 pb-3 font-codeProBold font-extrabold",children:"Phase 2"})}),e.jsxs("div",{className:"items grid gap-6 px-4",children:[e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Trading",e.jsx("b",{className:"font-bold",children:" Period"}),":"]}),e.jsx("div",{children:e.jsx("div",{className:"wrap flex gap-2 justify-center items-center relative z-[10]",children:e.jsx("div",{className:"col-span-2 flex justify-center items-center sm:w-[136px]",children:e.jsx("span",{className:"priceVal",children:N==="0"?"Unlimited":N==="45"?"45 Days":"60 Days"})})})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center relative z-[9]",children:[e.jsxs("span",{children:["Min. Trading",e.jsx("b",{className:"font-bold",children:" Days"}),":"]}),e.jsx("span",{className:"priceVal inline-flex justify-center items-center sm:w-[136px]",children:S==="0"?"0 Days":S==="3"?"3 Days":"5 Days"})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Max",e.jsx("b",{className:"font-bold",children:" Daily "})," Loss:"]}),e.jsx("div",{children:e.jsx("span",{className:"priceVal sm:w-[136px] flex justify-center",children:e.jsx("span",{className:"priceVal inline-flex justify-center items-center",children:F==="5"?l[t].maxDailyLossVal[0]:l[t].maxDailyLossVal[1]})})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Max",e.jsx("b",{className:"font-bold",children:" Overall "})," Loss:"]}),e.jsx("div",{children:e.jsx("span",{className:"priceVal sm:w-[136px] flex justify-center",children:e.jsx("span",{children:p==="12"?l[t].maxOverallLossVal[0]:p==="10"?l[t].maxOverallLossVal[1]:l[t].maxOverallLossVal[2]})})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Profit",e.jsx("b",{className:"font-bold",children:" target "}),":"]}),e.jsx("span",{className:"priceVal sm:w-[136px] flex justify-center",children:l[t].profitTargetVal[2]})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsx("span",{children:"Leverage:"}),e.jsx("div",{children:e.jsx("span",{className:"sm:w-[136px] flex justify-center",children:"1:100"})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Monthly ",e.jsx("b",{className:"font-bold",children:" Salary "}),":"]}),e.jsx("div",{children:e.jsx("span",{className:"sm:w-[136px] flex justify-center",children:"-"})})]})]})]})}),e.jsx(z,{children:e.jsxs("div",{className:"funded pt-2 pb-6 item grid gap-3 border border-primary/20 rounded-3xl uni-bg-gradient h-full card-shadow",children:[e.jsx("div",{className:"heading pb-3 mt-2 ",children:e.jsx("h3",{className:"px-5 text-center m-auto max-w-[10rem] border-b-2 border-primary/30 pb-3 font-codeProBold font-extrabold",children:"Funded"})}),e.jsxs("div",{className:"items grid gap-6 px-4",children:[e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Trading",e.jsx("b",{className:"font-bold",children:" Period"}),":"]}),e.jsx("div",{children:e.jsx("span",{className:"w-[122px] flex justify-center",children:"Unlimited"})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Min. Trading",e.jsx("b",{className:"font-bold",children:" Days"}),":"]}),e.jsx("span",{className:"w-[122px] flex justify-center",children:"-"})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Max",e.jsx("b",{className:"font-bold",children:" Daily "})," Loss:"]}),e.jsx("div",{children:e.jsx("span",{className:"w-[122px] flex justify-center",children:F==="5"?l[t].maxDailyLossVal[0]:l[t].maxDailyLossVal[1]})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Max",e.jsx("b",{className:"font-bold",children:" Overall "})," Loss:"]}),e.jsx("div",{children:e.jsx("span",{className:"w-[122px] flex justify-center",children:e.jsx("span",{children:p==="12"?l[t].maxOverallLossVal[0]:p==="10"?l[t].maxOverallLossVal[1]:l[t].maxOverallLossVal[2]})})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Profit",e.jsx("b",{className:"font-bold",children:" Target "}),":"]}),e.jsx("span",{className:"w-[122px] flex justify-center",children:"-"})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsx("span",{children:"Leverage:"}),e.jsx("div",{children:e.jsx("span",{className:"w-[122px] flex justify-center",children:"1:100"})})]}),e.jsxs("div",{className:"item flex justify-between gap-6 items-center",children:[e.jsxs("span",{children:["Monthly ",e.jsx("b",{className:"font-bold",children:" Salary "}),":"]}),e.jsx("div",{children:e.jsx("span",{className:"w-[122px] whitespace-nowrap flex justify-center",children:l[t].monthlySalaryVal[0]})})]})]})]})})]})}),e.jsxs("div",{className:"wrap mt-6 grid sm:grid-cols-2 justify-center items-center gap-4 w-full",children:[e.jsxs("div",{className:"grid justify-center",children:[e.jsxs("div",{className:"refund flex items-center justify-center",children:[e.jsx("span",{className:"!text-lg",children:"Refundable fee: "}),e.jsxs("h4",{className:"text-[1.5rem] font-Montserrat font-extrabold ml-4",children:["$ ",M]})]}),e.jsxs("div",{className:" font-Montserrat text-sm",children:["Or pay in 4 installments from"," ",e.jsxs("span",{className:"font-bold",children:["$",M/4]})," / Month"]})]}),e.jsx("div",{className:"btn flex w-full justify-center",children:e.jsx("div",{onClick:()=>i(!0),className:"font-Montserrat text-xs font-bold py-4 px-12  rounded-3xl home-glowing-btn uppercase",children:"Get Funded Now"})})]})]})]}),e.jsxs("div",{className:`modal fixed inset-0 z-[99999] transition-all duration-100 flex justify-center items-center overflow-hidden ${a?"visible opacity-100":"invisible opacity-0"}`,children:[e.jsx("div",{className:`bg absolute inset-0 w-full h-full transition-all duration-200 backdrop-blur-xl ${a?"opacity-100 ":"opacity-0"}`,onClick:()=>i(!1)}),e.jsxs("div",{className:`box relative m-6 max-w-[600px] w-full text-main text-wht bg-light-gray uni-bg-gradient transition-all duration-300 rounded-3xl z-[999] py-10 px-6 ${a?"visible opacity-100":"invisible opacity-0"}`,children:[e.jsxs("form",{className:"content grid w-full text-center gap-4 font-semibold",children:[e.jsx("div",{className:"heading text-xl mt-6 font-Montserrat",children:e.jsx("h3",{children:"To proceed with your purchase, kindly fill out the form below"})}),e.jsxs("div",{className:"wrap grid sm:grid-cols-2 gap-7 mt-4",children:[e.jsxs("div",{className:"name relative",children:[e.jsx("input",{name:"name",onChange:c=>d(c.target.value),required:!0,className:`name w-full  bg-transparent backdrop-blur-3xl border-none outline outline-2  py-2 md:py-2.5 px-6 rounded-3xl transition-all duration-200 ${u||s!==""?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,type:"text",value:s,placeholder:"Name"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1.25rem] text-red-600 text-[0.66rem] ${u||s!==""?"invisible opacity-0":"visible opacity-100"}`,children:"This field is required"})]}),e.jsxs("div",{className:"surname relative",children:[e.jsx("input",{name:"surname",required:!0,onChange:c=>m(c.target.value),value:h,className:`lastName w-full  bg-transparent backdrop-blur-3xl border-none outline outline-2  py-2 md:py-2.5 px-6 rounded-3xl transition-all duration-200 ${u||s!==""?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,placeholder:"Surname"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1.25rem] text-red-600 text-[0.66rem] ${u||h!==""?"invisible opacity-0":"visible opacity-100"}`,children:"This field is required"})]}),e.jsxs("div",{className:"email relative col-span-full",children:[e.jsx("input",{name:"email",required:!0,onChange:c=>o(c.target.value),value:n,className:`email w-full  bg-transparent backdrop-blur-3xl border-none outline outline-2  py-2 md:py-2.5 px-6 rounded-3xl transition-all duration-200 ${x?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,type:"email",placeholder:"Email"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1.25rem] text-red-600 text-[0.66rem] ${x?"invisible opacity-0":"visible opacity-100"}`,children:"Please enter a valid email address"})]})]}),e.jsx("div",{className:"proceed flex justify-center items-center mt-5",children:e.jsx("button",{onClick:c=>se(c),className:"py-2.5 px-16 transition-all duration-300 rounded-3xl font-Montserrat font-semibold glowing-btn max-w-[12rem] cursor-pointer",children:"Proceed payment"})})]}),e.jsx("div",{className:"cross",onClick:()=>i(!1),children:e.jsx(he,{className:"absolute cursor-pointer text-xl sm:text-2xl text-dim-gray right-4 md:right-6 top-4 md:top-6"})})]})]})]})}function ve(){return e.jsxs("section",{className:"prices relative pt-20 sm:pt-32",children:[e.jsx("div",{className:"border-b border-slate-400/10 left-1/2 transform -translate-x-1/2 absolute w-[80vw] m-auto -mt-10 sm:-mt-16"}),e.jsx("div",{className:"container relative z-10",children:e.jsx("div",{className:"wrapper relative z-20 grid 2xl:px-36",children:e.jsxs("div",{className:"heading flex flex-col sm:text-center",children:[e.jsx("h2",{className:"text-2xl xs:text-[1.7rem] text-wht-gradient",children:"Get Funded Now"}),e.jsx("p",{className:"mt-2 hidden sm:block",children:"Choose your favorite account size, start trading, earn profit-splits and scale."}),e.jsxs("p",{className:"sm:hidden mt-2 ml-5 relative before:absolute before:w-2 before:h-2 before:bg-white before:left-[-1rem] before:rounded-full before:top-1/2 before:transform before:-translate-y-1/2",children:[" ",e.jsx("b",{className:"font-bold",children:"Step 1:"})," Choose your balance:"]})]})})}),e.jsx("div",{className:"wrap sm:max-w-[70rem] px-[1.5rem] md:px-0 sm:w-full sm:m-auto sm:pt-4 overflow-hidden",children:e.jsx(xe,{})}),e.jsx("div",{className:"circle-shadow hidden sm:grid justify-end absolute opacity-[40%] -top-[50%] -right-0 w-full h-full max-w-[50rem]",children:e.jsx("img",{className:"w-full",src:I,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow sm:hidden absolute grid justify-end items-end opacity-[33%] bottom-0 -top-[40%] rotate-180 left-0 w-full h-full max-w-[40rem]",children:e.jsx("img",{src:I,alt:"circle-shadow"})})]})}function w(){const[a,i]=r.useState(!1),[n,o]=r.useState(window.pageYOffset),[s,d]=r.useState(!0);window.onscroll=function(){const u=window.pageYOffset;n>u?d(!0):d(!1),n<=1&&d(!0),o(u)};const{pathname:h}=k();r.useEffect(()=>{window.scrollTo(0,0)},[h]);const m=()=>{navigator.clipboard.writeText("LAUNCH20")};return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"uni-bg-gradient fixed left-0 right-0 z-[9999] bg-black",children:e.jsxs("div",{onClick:m,className:"container text-[0.8rem] sm:text-base md:text-lg !py-4 px-3 text-center text-white flex justify-center font-Montserrat sm:cursor-pointer",children:[e.jsxs("span",{className:"font-bold px-1.5 font-Montserrat text-[0.8rem] sm:text-base md:text-lg",children:[" ","20% OFF"," "]}),"LAUNCH PROMO -",e.jsx("span",{className:"font-bold px-1.5 font-Montserrat text-[0.8rem] sm:text-base md:text-lg",children:'"LAUNCH20"'})]})}),e.jsx("header",{className:`uppercase transition-all duration-300 border-b border-transparent fpy-3 pb-3 fixed z-[999] left-0 right-0 ftop-0 top-[3.2rem] pt-2 bg-black/60 shadow-2xl backdrop-blur-3xl transform ${s?"translate-y-0":"-translate-y-[140px]"}`,children:e.jsx("div",{className:"container pt-3",children:e.jsxs("div",{className:"wrapper flex justify-between z-[999]",children:[e.jsx(f,{to:"/",className:"main-logo",children:e.jsx("img",{className:"max-w-[8rem] sm:max-w-[10rem]",src:R,alt:"TheFundedHub"})}),e.jsxs("nav",{className:"nav-links text-wht font-light flex justify-center items-center",children:[e.jsxs("ul",{className:"hidden md:flex gap-6 justify-center items-center text-sm",children:[e.jsx("li",{children:e.jsx(f,{to:"/blog",className:`flex font-Montserrat font-semibold border-b border-transparent hover:text-white transition-all duration-300 ${h==="/blog"?"text-white":"text-white/40"}`,children:"BLOG"})}),e.jsx("li",{children:e.jsx(f,{to:"/faq",className:`flex font-Montserrat font-semibold border-b border-transparent hover:text-white transition-all duration-300 ${h==="/faq"?"text-white":"text-white/40"}`,children:"FAQ"})}),e.jsx("li",{children:e.jsx(f,{to:"/contact-us",className:`flex relative group font-Montserrat font-semibold border-b border-transparent fhover:text-white transition-all duration-300 ${h==="/contact-us"?"text-white":"text-white/40"}`,children:"CONTACT US"})}),e.jsx("li",{className:"relative",children:e.jsx("a",{href:"https://dashboard.thefundedhub.com/",className:"bg-primary/20 md:bg-transparent flex justify-center items-center py-2.5 px-7 sm:px-12 hover:text-white/70 text-white transition-all duration-200 rounded-3xl whitespace-nowrap font-Montserrat font-semibold text-[0.9rem] w-full glowing-btn uppercase pb-[0.725rem]",children:"Personal Hub Login"})})]}),e.jsx("div",{className:"menu-bar md:hidden",children:e.jsx("svg",{onClick:()=>i(!a),stroke:"currentColor",fill:"currentColor",strokeWidth:"0",viewBox:"0 0 1024 1024",height:"1.8em",width:"1.8em",xmlns:"http://www.w3.org/2000/svg",children:e.jsx("path",{d:"M904 160H120c-4.4 0-8 3.6-8 8v64c0 4.4 3.6 8 8 8h784c4.4 0 8-3.6 8-8v-64c0-4.4-3.6-8-8-8zm0 624H120c-4.4 0-8 3.6-8 8v64c0 4.4 3.6 8 8 8h784c4.4 0 8-3.6 8-8v-64c0-4.4-3.6-8-8-8zm0-312H120c-4.4 0-8 3.6-8 8v64c0 4.4 3.6 8 8 8h784c4.4 0 8-3.6 8-8v-64c0-4.4-3.6-8-8-8z"})})})]})]})})}),e.jsxs("div",{className:"mobile-nav z-[9999] relative uppercase",children:[e.jsx("svg",{onClick:()=>i(!1),className:`text-wht fixed right-[5%] top-8 z-[88] transition-all duration-500 ${a?"opacity-100 rotate-180 visible":"opacity-0 invisible"}`,stroke:"currentColor",fill:"none",strokeWidth:"0",viewBox:"0 0 15 15",height:"2.2em",width:"2.2em",xmlns:"http://www.w3.org/2000/svg",children:e.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z",fill:"currentColor"})}),e.jsx("div",{onClick:()=>i(!1),className:`darkbg fixed inset-0 bg-main-bg/20 bottom-0  backdrop-blur-xl z-[77] transition-all duration-500 ${a?"opacity-100 visible":"opacity-0 invisible"}`}),e.jsx("nav",{className:`mobile-nav md:hidden fixed top-0 bottom-0 w-[80%] xs:w-[70%] sm:w-[60%] bg-main-bg/30 z-[99] transition-all duration-500 ${a?"left-0 opacity-100":"-left-full opacity-0"}`,children:e.jsxs("div",{className:"wrapper",children:[e.jsx(f,{to:"/",className:"logo block pt-6 px-6",children:e.jsx("img",{className:"max-w-[10rem] w-full md:hidden",src:R,alt:"TheFundedHub"})}),e.jsxs("ul",{className:"flex flex-col justify-start text-sm mt-6",children:[e.jsx("li",{children:e.jsx(f,{to:"/blog",className:"flex font-Montserrat py-3 pl-6 w-full font-semibold border-y border-light/30 transition-all duration-300",children:"Blog"})}),e.jsx("li",{children:e.jsx(f,{to:"/faq",className:"flex font-Montserrat py-3 pl-6 w-full font-semibold border-b border-light/30 transition-all duration-300",children:"FAQ"})}),e.jsx("li",{children:e.jsx(f,{to:"/contact-us",className:"flex font-Montserrat py-3 pl-6 w-full font-semibold border-b border-light/30 transition-all duration-300",children:"Contact Us"})}),e.jsx("li",{className:"flex mt-4 pl-6",children:e.jsx("a",{href:"https://dashboard.thefundedhub.com/",className:"flex justify-center items-center font-Montserrat font-semibold rounded-3xl w-56 h-10 glowing-btn uppercase text-base",children:"Personal Hub Login"})})]})]})})]})]})}const be=[{name:"PHASE 1",content:`<p>
        ...
        potential rewards.
                  ...
                  `,src:je,alt:"x"})}),e.jsxs("div",{className:"w-full flex flex-col justify-between gap-8",children:[e.jsx("p",{className:"text-center",children:"To ensure you're always in the know about TFH's official updates and news, don't forget to follow us on Twitter! Stay tuned for the latest developments."}),e.jsx("div",{className:" btn uppercase flex justify-center",children:e.jsx("a",{target:"__blank",href:"https://twitter.com/TheFundedHub",className:"uppercase font-base flex h-full justify-center items-center py-3 px-10 text-white rounded-3xl whitespace-nowrap font-Montserrat font-semibold text-[0.8rem]  max-w-[228px] border-2 border-primary/30",children:"Join us on Twitter"})})]})]}),e.jsxs("div",{className:"gridf hidden gap-4 px-6 pt-2 pb-8 rounded-3xl h-full insta-bg social-shadow max-w-[360px]",children:[e.jsx("div",{className:"img flex justify-center items-center",children:e.jsx("img",{className:`sm:max-w-[12rem] md:max-w-[12rem] w-full opacity-80\r
                  `,src:Ne,alt:"instagram"})}),e.jsxs("div",{className:"w-full grid justify-center gap-3",children:[e.jsx("p",{className:"text-center",children:"Trading is certainly not easy! Interact with other traders and discuss about the markets, strategies and stay up to date with all the TFH official announcements."}),e.jsx("div",{className:"mt-4 btn uppercase flex justify-center",children:e.jsx("a",{target:"__blank",href:"https://www.instagram.com/fundedhub/",className:"uppercase font-base flex h-full justify-center items-center py-3 px-10 text-white border-primary rounded-3xl whitespace-nowrap font-Montserrat font-semibold text-[0.8rem] max-w-[228px] insta-glowing-btn",children:"Join us on Instagram"})})]})]})]})]}),e.jsx("div",{className:"circle-shadow hidden sm:block absolute opacity-[40%] -top-[60%] -left-[50%] w-full h-full sm:min-w-[50rem]",children:e.jsx("img",{className:"w-full",src:T,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow sm:hidden absolute grid justify-end items-end opacity-[40%] bottom-0 -top-[30%] right-0 w-full h-full max-w-[40rem]",children:e.jsx("img",{src:I,alt:"circle-shadow"})})]})}const Se="/assets/x-a3a9855d.webp",Fe="/assets/discord-b0b80765.webp",Ce="/assets/instagram-3e95cfc6.webp";function $(){return e.jsxs("div",{className:"logos flex gap-4",children:[e.jsx("a",{target:"__blank",href:"https://www.instagram.com/fundedhub/",className:"w-[1.5rem] hover:opacity-70 transition-all duration-300 flex justify-center items-center",children:e.jsx("img",{className:"w-full",src:Ce,alt:"Instagram"})}),e.jsx("a",{target:"__blank",href:"https://twitter.com/TheFundedHub",className:"logo w-[1.5rem] hover:opacity-70 transition-all duration-300 flex justify-center items-center",children:e.jsx("img",{className:"w-full",src:Se,alt:"X"})}),e.jsx("a",{target:"__blank",href:"https://discord.gg/thefundedhub",className:"logo w-[1.9rem] hover:opacity-70 transition-all duration-300 flex justify-center items-center",children:e.jsx("img",{className:"w-full",src:Fe,alt:"discord"})})]})}function j(){const[a,i]=r.useState(""),{pathname:n}=k();return r.useEffect(()=>{i(n)},[]),e.jsx("footer",{className:"footer relative body-background pt-6 pb-5 z-40",children:e.jsxs("div",{className:"container relative z-10",children:[e.jsxs("div",{className:"footer-desktop hidden lg:grid gap-10",children:[e.jsxs("div",{className:"top flex justify-between",children:[e.jsx("div",{className:"left ",children:e.jsx(f,{to:"/",className:"main-logo flex gap-1",children:e.jsx("img",{className:"max-w-[10rem]",src:R,alt:"TheFundedHub"})})}),e.jsx("div",{className:"middle grid gap-6 justify-end items-center",children:e.jsx("div",{className:"item flex justify-center items-center",children:e.jsxs("ul",{className:"flex font-Montserrat font-medium gap-4 flex-wrap md:flex-nowrap",children:[e.jsx("li",{children:e.jsx(f,{onClick:()=>i("/terms-condition"),to:"/terms-condition",className:`text-sm  hover:text-white transition-all duration-300 ${a==="/terms-condition"?"text-white":"text-white/40"}`,children:"Terms and Condition"})}),e.jsx("li",{children:e.jsx(f,{onClick:()=>i("/privacy-policy"),to:"/privacy-policy",className:`text-sm  hover:text-white transition-all duration-300 ${a==="/privacy-policy"?"text-white":"text-white/40"}`,children:"Privacy Policy"})}),e.jsx("li",{children:e.jsx(f,{onClick:()=>i("/cookie-policy"),to:"/cookie-policy",className:`text-sm  hover:text-white transition-all duration-300 ${a==="/cookie-policy"?"text-white":"text-white/40"}`,children:"Cookie Policy"})}),e.jsx("li",{children:e.jsx(f,{onClick:()=>i("/risk-disclosure"),to:"/risk-disclosure",className:`text-sm  hover:text-white transition-all duration-300 ${a==="/risk-disclosure"?"text-white":"text-white/40"}`,children:"Risk Disclosure"})}),e.jsx("li",{children:e.jsx(f,{onClick:()=>i("/report-problem"),to:"/report-problem",className:`text-sm relative group hover:text-white transition-all duration-300  ${a==="/report-problem"?"text-white":"text-white/40"}`,children:"Report a problem"})})]})})}),e.jsx("div",{className:"right",children:e.jsx($,{})})]}),e.jsx("div",{className:"bottom",children:e.jsx("div",{className:"hidden sm:block bottom-content text-center",children:e.jsx("p",{className:"text-[0.65rem] font-light mt-2",children:"The Funded Hub is a brand owned by THE FUNDED HUB GLOBAL LLP. All information available on this site is intended solely for the study purposes related to trading on financial markets and does not serve in any way as a specific investment recommendation, business recommendation, investment opportunity analysis or similar general recommendation regarding the trading of investment instruments. Trading in financial markets is a high-risk activity and it is advised not to risk more than one can afford to lose! THE FUNDED HUB GLOBAL LLP does not provide any of the investment services listed in the Capital Market Undertakings Act No. 256/2004 Coll. The information on this site is not directed at residents in any country or jurisdiction where such distribution or use would be contrary to local laws or regulations. Either The Funded Hub and THE FUNDED HUB GLOBAL LLP is not a broker and do not accept deposits. The offered technical solution for the The Funded Hub MT5 platforms and data feed are powered by our institutional liquidity providers."})})})]}),e.jsxs("div",{className:"footer-mobile grid gap-6 lg:hidden",children:[e.jsxs("div",{className:"flex justify-between gap-4",children:[e.jsx("div",{className:"logo flex justify-center items-center",children:e.jsx(f,{to:"/",className:"main-logo flex gap-1",children:e.jsx("img",{className:"max-w-[8rem]",src:R,alt:"TheFundedHub"})})}),e.jsx($,{})]}),e.jsxs("div",{className:"content grid gap-8 mt-4",children:[e.jsx("div",{className:"top",children:e.jsx("div",{className:"items gap-4",children:e.jsx("div",{className:"item grid justify-center items-center",children:e.jsxs("ul",{className:"flex flex-wrap gap-4 justify-center items-center",children:[e.jsx("li",{children:e.jsx(f,{onClick:()=>i("/terms-condition"),to:"/terms-condition",className:` ${a==="/terms-condition"?"text-white":"text-white/40"} hover:text-white`,children:"Term and Condition"})}),e.jsx("li",{children:e.jsx(f,{onClick:()=>i("/privacy-policy"),to:"/privacy-policy",className:` ${a==="/privacy-policy"?"text-white":"text-white/40"} hover:text-white`,children:"Privacy Policy"})}),e.jsx("li",{children:e.jsx(f,{onClick:()=>i("/ookie-policy"),to:"/cookie-policy",className:` ${a==="/cookie-policy"?"text-white":"text-white/40"} hover:text-white`,children:"Cookie Policy"})}),e.jsx("li",{children:e.jsx(f,{onClick:()=>i("/risk-disclosure"),to:"/risk-disclosure",className:` ${a==="/risk-disclosure"?"text-white":"text-white/40"} hover:text-white`,children:"Risk Disclosure"})}),e.jsx("li",{children:e.jsx(f,{onClick:()=>i("/report-problem"),to:"/report-problem",className:` relative group ${a==="/report-problem"?"text-white":"text-white/40"} fhover:text-white`,children:"Report a problem"})})]})})})}),e.jsx("div",{className:"bottom text-center",children:e.jsx("p",{className:"text-[0.65rem] font-light mt-2",children:"The Funded Hub is a brand owned by THE FUNDED HUB GLOBAL LLP. All information available on this site is intended solely for the study purposes related to trading on financial markets and does not serve in any way as a specific investment recommendation, business recommendation, investment opportunity analysis or similar general recommendation regarding the trading of investment instruments. Trading in financial markets is a high-risk activity and it is advised not to risk more than one can afford to lose! THE FUNDED HUB GLOBAL LLP does not provide any of the investment services listed in the Capital Market Undertakings Act No. 256/2004 Coll. The information on this site is not directed at residents in any country or jurisdiction where such distribution or use would be contrary to local laws or regulations. Either The Funded Hub and THE FUNDED HUB GLOBAL LLP is not a broker and do not accept deposits. The offered technical solution for the The Funded Hub MT5 platforms and data feed are powered by our institutional liquidity providers."})})]})]})]})})}const Ae="/assets/select-e68781a8.png",Ee="/assets/BlackBull-logo-ce4aa3ed.png",Ie="/assets/klarna-after-pay-0bcee81f.png",Pe=[{name:"<span>CRAFT</span> YOUR CHALLENGE",img:Ae,content:`<p>
     ...
     <p>
      ...
      <p>
        ...
        article directly following this one.
            ...
            </div>`}];return e.jsxs("section",{className:"home-faq relative pt-28 overflow-hidden",children:[e.jsx("div",{className:"border-b border-slate-400/10 left-1/2 transform -translate-x-1/2 absolute w-[80vw] m-auto  -mt-14"}),e.jsx("div",{className:"container relative z-10",children:e.jsxs("div",{className:"wrapper grid gap-8 justify-center items-center",children:[e.jsxs("div",{className:"heading flex flex-col gap-2 justify-center items-center text-center",children:[e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.7rem] tracking-tight text-wht-gradient",children:"FAQ"}),e.jsx("div",{className:"paras",children:e.jsxs("p",{children:["If you don't find an answer in the frequently asked questions don't hesitate to"," ",e.jsx(f,{to:"/contact",className:"underline font-semibold",children:"contact us"})]})})]}),e.jsx("div",{className:"articles md:max-w-[60rem] m-auto grid gap-5",children:i.map((n,o)=>e.jsx(Me,{heading:n.name,para:n.data,openFaq:a,i:o},o))}),e.jsx("div",{className:"readmore flex justify-center mb-12 xs:mb-24 md:mb-32",children:e.jsx(f,{to:"faq",className:"text-xs x:text-sm font-bold py-2 px-10 border-2 border-primary/20 rounded-3xl",children:"Visit FAQ Page"})})]})}),e.jsx("div",{className:"circle-shadow absolute grid justify-end items-end opacity-[23%] bottom-0 right-0 w-full h-full max-w-[40rem]",children:e.jsx("img",{src:I,alt:"circle-shadow"})})]})}function qe(){const{pathname:a}=k(),[i,n]=r.useState(!1);return r.useEffect(()=>{window.scrollTo(0,0)},[a]),e.jsxs("div",{className:"font-light",children:[e.jsx(w,{}),e.jsx(Oe,{}),e.jsx(we,{}),e.jsx(Le,{setOpenFaq:n}),e.jsx(ve,{}),e.jsx(Te,{}),e.jsx(De,{openFaq:i}),e.jsx(j,{}),e.jsx("div",{className:"hidden h-0 w-0 opacity-0 left-0 visible md:invisible"}),e.jsx("script",{src:"./js/script.js"})]})}function ae({clr:a,header:i}){const[n,o]=r.useState(""),[s,d]=r.useState(""),[h,m]=r.useState(""),[u,y]=r.useState(""),[x,C]=r.useState(""),[A,P]=r.useState(""),[t,g]=r.useState(!0),[N,E]=r.useState(!0),[S,L]=r.useState(!1);r.useEffect(()=>{/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(h)&&h!==""?E(!0):S&&E(!1)},[h,t]);const F=()=>{n&&s&&N&&u&&x!==""?q.post("https://api.thefundedhub.com/v1/website/questions",{firstName:n,lastName:s,email:h,subject:u,message:x}).then(p=>{P("success"),o(""),d(""),m(""),y(""),C(""),g(!0),E(!0)}).catch(p=>{P("failed")}):(g(!1),L(!0))},O=p=>{p.preventDefault(),F(),P("")};return e.jsxs(e.Fragment,{children:[e.jsxs("form",{className:`grid gap-6 sm:gap-8 md:gap-10 px-4 py-6 sm:p-8 relative z-10 rounded-3xl border-primary backdrop-blur-3xl global-shadow  ${a==="dash-bar-clr"?"contact-clr":"uni-bg-gradient"}`,children:[e.jsx("div",{className:"head",children:e.jsx("h3",{className:"text-xl",children:i||"Have questions?"})}),e.jsxs("div",{className:"inputs grid sm:grid-cols-2 gap-7",children:[e.jsxs("div",{className:"name relative",children:[e.jsx("input",{name:"name",onChange:p=>o(p.target.value),required:!0,className:`name w-full  bg-transparent backdrop-blur-3xl border-none outline outline-2  py-2 md:py-2.5 px-6 rounded-3xl transition-all duration-200 ${t||n!==""?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,type:"text",value:n,placeholder:"Name"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1.25rem] text-red-600 text-[0.66rem] ${t||n!==""?"invisible opacity-0":"visible opacity-100"}`,children:"This field is required"})]}),e.jsxs("div",{className:"surname relative",children:[e.jsx("input",{name:"surname",onChange:p=>d(p.target.value),value:s,className:`lastName w-full  bg-transparent backdrop-blur-3xl border-none outline outline-2  py-2 md:py-2.5 px-6 rounded-3xl transition-all duration-200 ${t||n!==""?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,placeholder:"Surname"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1.25rem] text-red-600 text-[0.66rem] ${t||s!==""?"invisible opacity-0":"visible opacity-100"}`,children:"This field is required"})]}),e.jsxs("div",{className:"email relative",children:[e.jsx("input",{name:"email",required:!0,onChange:p=>m(p.target.value),value:h,className:`email w-full  bg-transparent backdrop-blur-3xl border-none outline outline-2  py-2 md:py-2.5 px-6 rounded-3xl transition-all duration-200 ${N?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,type:"email",placeholder:"Email"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1.25rem] text-red-600 text-[0.66rem] ${N?"invisible opacity-0":"visible opacity-100"}`,children:"Please enter a valid email address"})]}),e.jsxs("div",{className:"subject relative",children:[e.jsx("input",{name:"subject",required:!0,onChange:p=>y(p.target.value),value:u,className:`subject w-full  bg-transparent backdrop-blur-3xl border-none outline outline-2  py-2 md:py-2.5 px-6 rounded-3xl transition-all duration-200 ${t||u!==""?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,type:"text",placeholder:"Subject"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1.25rem] text-red-600 text-[0.66rem] ${t||u!==""?"invisible opacity-0":"visible opacity-100"}`,children:"This field is required"})]})]}),e.jsxs("div",{className:"textarea relative",children:[e.jsx("textarea",{onChange:p=>C(p.target.value),required:!0,value:x,className:`bg-transparent backdrop-blur-3xl border-none outline outline-2 p-4 rounded-xl transition-all duration-200 w-full min-h-[10rem] sm:min-h-[12rem] md:min-h-[15rem] ${t||x!==""?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,name:"message",id:"message",placeholder:"Comment"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1rem] text-red-600 text-[0.66rem] ${t||x!==""?"invisible opacity-0":"visible opacity-100"}`,children:"This field is required"})]}),e.jsx("div",{className:"login-btn flex justify-center items-center",children:e.jsx("button",{onClick:p=>O(p),className:"py-2.5 px-16 transition-all duration-300 rounded-3xl font-Montserrat font-semibold glowing-btn max-w-[12rem] cursor-pointer",children:"Send"})})]}),e.jsx("div",{className:`box  fixed z-[999999] top-[30%] transform -translate-y-1/2 -right-[3rem] lg:-right-[4rem]  text-main text-wht bg-light-gra transition-all border border-primary/10 backdrop-blur-3xl duration-300 rounded-l-full my-3 overflow-hidden p-3 sm:p-5 px-12 md:w-[30rem] text-center ${A==="success"?" bg-[#08be00] contact-send-popup":A==="failed"?"bg-red-600 contact-send-popup":"invisible opacity-0"}`,children:e.jsx("div",{className:"subscribe text-base sm:text-xl font-nomal text-center pr-[1.5rem]",children:A==="success"?e.jsx("div",{children:"Message Sent!"}):A==="failed"?e.jsx("div",{children:"Sorry, please try again :("}):""})})]})}function Re(){const{pathname:a}=k();return r.useEffect(()=>{window.scrollTo(0,0)},[a]),e.jsxs(e.Fragment,{children:[e.jsx(w,{}),e.jsxs("section",{className:"contact relative pt-40 sm:pt-52 pb-28 sm:pb-44 overflow-hidden",children:[e.jsx("div",{className:"container z-10 relative",children:e.jsx("div",{className:"wrapper flex items-center justify-center w-full",children:e.jsxs("div",{className:"content grid md:grid-cols-3 gap-10 max-w-[75rem] w-full",children:[e.jsxs("div",{className:"left md:col-span-1",children:[e.jsxs("div",{className:"heading grid gap-2",children:[e.jsx("div",{className:"wrap",children:e.jsx("h3",{className:"text-3xl text-wht-gradient",children:"Contact Us"})}),e.jsxs("p",{children:["Questions? Doubts? ",e.jsx("br",{})," Please contact us anytime and our team will take care of you!"]})]}),e.jsx("div",{className:"mt-5",children:e.jsx($,{})})]}),e.jsx("div",{className:"right md:col-span-2",children:e.jsx(ae,{})})]})})}),e.jsx("div",{className:"circle-shadow absolute opacity-[33%] -top-[10%] -left-[50%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:T,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow absolute opacity-[25%] top-[40%] -right-[20%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:T,alt:"circle-shadow"})})]}),e.jsx(j,{})]})}function $e(){const{pathname:a}=k();return r.useEffect(()=>{window.scrollTo(0,0)},[a]),e.jsxs(e.Fragment,{children:[e.jsx(w,{}),e.jsxs("section",{className:"contact relative pb-28 pt-40 sm:pt-52 sm:pb-44 overflow-hidden",children:[e.jsx("div",{className:"container z-10 relative",children:e.jsx("div",{className:"wrapper flex items-center w-full",children:e.jsxs("div",{className:"content grid md:grid-cols-3 gap-10 max-w-[75rem] w-full m-auto",children:[e.jsxs("div",{className:"left md:col-span-1 break-all ",children:[e.jsxs("div",{className:"heading grid gap-2",children:[e.jsx("h3",{className:"text-3xl",children:"Report a Problem"}),e.jsxs("p",{children:["Did you notice any bug or technical error? ",e.jsx("br",{})," Please let us know!"]})]}),e.jsx("div",{className:"mt-5",children:e.jsx($,{})})]}),e.jsx("div",{className:"right md:col-span-2",children:e.jsx(ae,{header:"Contact Us"})})]})})}),e.jsx("div",{className:"circle-shadow absolute opacity-[15%] -top-[70%] -left-[50%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:T,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow absolute opacity-[20%] top-[40%] -right-[20%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:T,alt:"circle-shadow"})})]}),e.jsx(j,{})]})}function We({heading:a,para:i,fls:n}){const[o,s]=r.useState(0),[d,h]=r.useState(n),m=r.useRef(null);return r.useEffect(()=>{s(m.current.clientHeight)},[d]),e.jsxs("article",{className:"item rounded-xl global-shadow ",children:[e.jsxs("header",{onClick:()=>h(!d),className:"flex justify-between cursor-pointer py-3 px-4",children:[e.jsx("h3",{className:"text-[0.9rem] xs:text-base font-Montserrat font-semibold",children:e.jsx("div",{dangerouslySetInnerHTML:{__html:a}})}),e.jsx("div",{className:"arrow flex justify-center items-center ml-3",children:e.jsx("img",{className:`max-w-[1.4rem] transform-gpu transition-all duration-300 ${d?"rotate-180":""}`,src:b,alt:"arrow"})})]}),e.jsx("div",{style:{maxHeight:d?o+"px":"0"},className:"faq-content transition-all duration-300 overflow-hidden ",children:e.jsx("div",{ref:m,className:"wrapper",children:e.jsx("div",{className:"text-[0.9rem] xs:text-base px-4 pb-5 pt-4 border-t border-primary/20",children:e.jsx("div",{className:"faq-collaps",dangerouslySetInnerHTML:{__html:i}})})})})]})}let ze={General:[{name:"The Funded Hub: Empowering Traders, one step at a time",data:`<div className="paras">
              <p>
...
`},{link:"blog-5",img:"",title:"Introduction to Forex Trading with The Funded Hub: A Beginner's Guide",para:`<span></span> Explore the power of leverage
          ...
          `},{link:"blog-12",img:"",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function Je(){let[a,i]=r.useState(1);const n=6,o=Math.ceil(B.length/n),s=_e(B,n),d=(m,u)=>{i(u),s.jump(u)},h=me({palette:{mode:"dark"}});return e.jsxs(e.Fragment,{children:[e.jsx(w,{}),e.jsxs("section",{className:"blog relative pt-36 sm:pt-48 pb-28 sm:pb-44 overflow-hidden",children:[e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"header flex justify-between w-full",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.7rem] tracking-tight text-wht-gradient",children:"Blog"})}),e.jsx("div",{className:"blogs mt-12 grid sm:grid-cols-2 md:grid-cols-3 gap-6 relative",children:s.currentData().map((m,u)=>e.jsxs(f,{to:`/blog/${m.link}`,className:"single-blog p-[0.9rem] bg-light/20 backdrop-blur-3xl rounded-xl !relative global-shadow grid justify-between items-end gap-4",children:[e.jsx("div",{className:"blog-img rounded-md hidden",children:e.jsx("img",{className:"rounded-md w-full h-full leading-none",src:m.img,alt:m.alt})}),e.jsxs("div",{className:"texts fmt-6 grid gap-3 pb-8",children:[e.jsx("h3",{className:"font-semibold",children:m.title}),e.jsx("div",{className:"blog-para-slice",children:e.jsx("p",{dangerouslySetInnerHTML:{__html:m.para.slice(0,140)+"...."}})}),e.jsx("div",{className:"date text-sm absolute bottom-3",children:m.date})]})]},m.title+u))}),e.jsx("div",{className:"pagination mt-10 flex justify-center",children:e.jsx(fe,{theme:h,children:e.jsx(ge,{spacing:2,children:e.jsx(ye,{count:o,page:a,shape:"rounded",variant:"outlined",color:"secondary",onChange:d})})})})]})}),e.jsx("div",{className:"circle-shadow absolute opacity-[23%] -top-[10%] -left-[50%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:T,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow absolute opacity-[25%] top-[40%] -right-[20%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:T,alt:"circle-shadow"})})]}),e.jsx(j,{})]})}function Xe(){const{pathname:a}=k(),i=B.filter(({link:n})=>n===a.slice(6));return e.jsxs(e.Fragment,{children:[e.jsx(w,{}),e.jsx("section",{className:"single-blog relative pt-16f pt-24 sm:pt-20 pb-28 sm:pb-44 overflow-hidden",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"flex justify-center items-center blog-content",children:e.jsx("div",{className:"blog-img p-[0.03rem] rounded-md",children:e.jsx("img",{className:"rounded-md",src:"",alt:i.alt})})}),e.jsxs("div",{className:"blog-content ",children:[e.jsx("div",{className:"heading",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.9rem] tracking-tight text-wht-gradient",children:i[0].title})}),e.jsxs("div",{className:"blog-wrap-data global-shadow",children:[e.jsx("div",{className:"data ",dangerouslySetInnerHTML:{__html:i[0].data}}),e.jsx("div",{className:"btn mt-10 m-auto max-w-[17rem]",children:e.jsx(f,{link:"/#price-table",className:"uppercase font-Montserrat text-sm font-semibold  transition-all duration-200 glowing-btn",children:"Get Funded Now"})})]})]})]})})}),e.jsx(j,{})]})}function Ze(){return e.jsxs(e.Fragment,{children:[e.jsx(w,{}),e.jsx("section",{className:"py-32 lg:py-44 relative purple-shadow min-h-[80vh]",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper grid gap-3 justify-center items-center text-center text-2xl sm:text-3xl md:text-[2rem] lg:text-4xl ",children:[e.jsx("h1",{children:"Sorry, your payment is unsuccessful :("}),e.jsx("h1",{children:"Please try again"})]})})}),e.jsx(j,{})]})}function Qe({children:a}){const[i,n]=r.useState("UNPAID"),[o,s]=r.useState(!1),d=localStorage.getItem("purchaseUuid"),h="https://development-api.thefundedhub.com",m=window.location.href;return console.log(d),q.put(`${h}/v1/website/purchases/${d}`,{paymentReference:m.split("session=")[1]}).then(u=>{n(u.data.data.status),s(!0),console.log("loaded")}).catch(u=>{console.log("not loaded")}),o?e.jsx(e.Fragment,{children:i==="PAID"?a:e.jsx(ue,{to:"/payment-error"})}):e.jsx("div",{className:"flex justify-center items-center h-screen",children:e.jsx("div",{className:"loader text-primary text-2xl",children:"Loading..."})})}ee.initialize("G-0GFK77GQTB");ee.send({hitType:"pageview",page:window.location.pathname});const ea="ef72a2fc-1672-41b9-acd5-260aac3e06ba";function aa(){return e.jsxs("div",{className:"App body-background",children:[e.jsx(le,{children:e.jsxs(pe,{children:[e.jsx(v,{path:"/",element:e.jsx(qe,{})}),e.jsx(v,{path:"contact-us",element:e.jsx(Re,{})}),e.jsx(v,{path:"report-problem",element:e.jsx($e,{})}),e.jsx(v,{path:"faq",element:e.jsx(Be,{})}),e.jsx(v,{path:"cookie-policy",element:e.jsx(Ue,{})}),e.jsx(v,{path:"privacy-policy",element:e.jsx(Ve,{})}),e.jsx(v,{path:"terms-condition",element:e.jsx(Ye,{})}),e.jsx(v,{path:"risk-disclosure",element:e.jsx(Ge,{})}),e.jsx(v,{path:"payment-error",element:e.jsx(Ze,{})}),e.jsx(v,{path:"thank-you",element:e.jsx(Qe,{children:e.jsx(Ke,{})})}),e.jsx(v,{path:"blog",element:e.jsx(Je,{})}),e.jsx(v,{path:"blog/:blog",element:e.jsx(Xe,{})})]})}),e.jsx(te,{defer:!0,zendeskKey:ea})]})}oe.createRoot(document.getElementById("root")).render(e.jsx(ne.StrictMode,{children:e.jsx(aa,{})}));
