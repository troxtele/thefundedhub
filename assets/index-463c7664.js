...
`},{link:"blog-5",title:"Introduction to Forex Trading with The Funded Hub: A Beginner&apos;s Guide",para:`<span>Meta Description:</span> Explore the power of leverage
          ...
          `},{link:"blog-12",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function ot(){const{pathname:t}=k(),a=nt.filter(({link:i})=>i===t.slice(6));return e.jsxs(e.Fragment,{children:[e.jsx(A,{}),e.jsx("section",{className:"single-blog relative pt-32 sm:pt-48 pb-28 sm:pb-44 purple-shadow",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"flex justify-center items-center",children:e.jsx("div",{className:"blog-img p-[0.03rem] rounded-md",children:e.jsx("img",{className:"rounded-md",src:me,alt:""})})}),e.jsxs("div",{className:"blog-content",children:[e.jsx("div",{className:"heading",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.9rem] tracking-tight text-wht-gradient",children:a[0].title})}),e.jsxs("div",{className:"blog-wrap-data",children:[e.jsx("div",{className:"data",dangerouslySetInnerHTML:{__html:a[0].data}}),e.jsx("div",{className:"btn mt-10 m-auto max-w-[17rem]",children:e.jsx(h,{to:"/",className:"uppercase font-Montserrat text-sm font-semibold  transition-all duration-200 glowing-btn",children:"Get Funded now"})})]})]})]})})}),e.jsx(F,{})]})}function lt(){return e.jsxs("div",{className:"App",children:[e.jsx(fe,{children:e.jsxs(ve,{children:[e.jsx(v,{path:"/",element:e.jsx(wa,{})}),e.jsx(v,{path:"login",element:e.jsx(ka,{})}),e.jsx(v,{path:"contact",element:e.jsx(Ta,{})}),e.jsx(v,{path:"faq",element:e.jsx(Sa,{})}),e.jsx(v,{path:"cookie-policy",element:e.jsx(Ca,{})}),e.jsx(v,{path:"privacy-policy",element:e.jsx(Pa,{})}),e.jsx(v,{path:"terms-condition",element:e.jsx(Aa,{})}),e.jsx(v,{path:"risk-disclosure",element:e.jsx(Fa,{})}),e.jsx(v,{path:"report-problem",element:e.jsx(Ma,{})}),e.jsx(v,{path:"blog",element:e.jsx(rt,{})}),e.jsx(v,{path:"blog/:blog",element:e.jsx(ot,{})}),e.jsxs(v,{path:"dashboard",element:e.jsx(za,{}),children:[e.jsx(v,{path:"Profile",element:e.jsx($a,{})}),e.jsx(v,{path:"billing",element:e.jsx(Ya,{})}),e.jsx(v,{path:"start-new-challenge",element:e.jsx(Ga,{})}),e.jsx(v,{path:"withdraw",element:e.jsx(Ua,{})}),e.jsx(v,{path:"top-up-reset",element:e.jsx(qa,{})}),e.jsx(v,{path:"help",element:e.jsx(Wa,{})}),e.jsx(v,{path:"dashboard-contact",element:e.jsx(Va,{})}),e.jsx(v,{path:"certificate",element:e.jsx(et,{})})]}),e.jsx(v,{path:"thank-you",element:e.jsx(at,{})}),e.jsx(v,{path:"payment-error",element:e.jsx(tt,{})})]})}),e.jsx(it,{})]})}ue.createRoot(document.getElementById("root")).render(e.jsx(pe.StrictMode,{children:e.jsx(lt,{})}));
