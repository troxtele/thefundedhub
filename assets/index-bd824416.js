...
`},{link:"blog-5",title:"Introduction to Forex Trading with The Funded Hub: A Beginner&apos;s Guide",para:`<span>Meta Description:</span> Explore the power of leverage
          ...
          `},{link:"blog-12",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function nt(){let[t,a]=s.useState(1);const i=6,r=Math.ceil(se.length/i),n=rt(se,i),l=(m,u)=>{a(u),n.jump(u)},o=Ze({palette:{mode:"dark"}});return e.jsxs(e.Fragment,{children:[e.jsx(E,{}),e.jsx("section",{className:"blog relative pt-32 sm:pt-48 pb-28 sm:pb-44 purple-shadow",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"header flex justify-between w-full",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.7rem] tracking-tight text-wht-gradient",children:"Blog"})}),e.jsx("div",{className:"blogs mt-12 grid sm:grid-cols-2 md:grid-cols-3 gap-6 relative",children:n.currentData().map((m,u)=>e.jsxs(c,{to:`/blog/${m.link}`,className:"single-blog p-[0.9rem] bg-light/20 backdrop-blur-3xl rounded-xl !relative",children:[e.jsx("div",{className:"blog-img rounded-md",children:e.jsx("img",{className:"rounded-md w-full h-full leading-none",src:J,alt:""})}),e.jsxs("div",{className:"texts mt-6 grid gap-3 pb-8",children:[e.jsx("h3",{className:"font-semibold",children:m.title}),e.jsx("div",{className:"blog-para-slice",children:e.jsx("p",{dangerouslySetInnerHTML:{__html:m.para.slice(0,140)+"...."}})}),e.jsx("div",{className:"date text-sm absolute bottom-3",children:m.date})]})]},m.title+u))}),e.jsx("div",{className:"pagination mt-10 flex justify-center",children:e.jsx(ea,{theme:o,children:e.jsx(aa,{spacing:2,children:e.jsx(ta,{count:r,page:t,shape:"rounded",variant:"outlined",color:"secondary",onChange:l})})})})]})})}),e.jsx(I,{})]})}const ot=[{link:"blog-1",title:"Leveraging Leverage: A Guide for Forex Traders",date:"26 August 2023",para:`<span>Meta Description:</span> Explore the power of leverage
                  in forex trading and how it can magnify your potential gains
                  and losses. Discover how to use leverage wisely with valuable
                  insights throughout the post. Forex trading offers an
                  incredible opportunity for traders to capitalize on currency
...
`},{link:"blog-5",title:"Introduction to Forex Trading with The Funded Hub: A Beginner&apos;s Guide",para:`<span>Meta Description:</span> Explore the power of leverage
          ...
          `},{link:"blog-12",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function lt(){const{pathname:t}=N(),a=ot.filter(({link:i})=>i===t.slice(6));return e.jsxs(e.Fragment,{children:[e.jsx(E,{}),e.jsx("section",{className:"single-blog relative pt-32 sm:pt-48 pb-28 sm:pb-44 purple-shadow",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"flex justify-center items-center",children:e.jsx("div",{className:"blog-img p-[0.03rem] rounded-md",children:e.jsx("img",{className:"rounded-md",src:J,alt:""})})}),e.jsxs("div",{className:"blog-content",children:[e.jsx("div",{className:"heading",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.9rem] tracking-tight text-wht-gradient",children:a[0].title})}),e.jsxs("div",{className:"blog-wrap-data",children:[e.jsx("div",{className:"data",dangerouslySetInnerHTML:{__html:a[0].data}}),e.jsx("div",{className:"btn mt-10 m-auto max-w-[17rem]",children:e.jsx(c,{to:"/",className:"uppercase font-Montserrat text-sm font-semibold  transition-all duration-200 glowing-btn",children:"Get Funded now"})})]})]})]})})}),e.jsx(I,{})]})}function dt(){return e.jsx("div",{className:"App",children:e.jsx(xe,{children:e.jsxs(be,{children:[e.jsx(y,{path:"/",element:e.jsx(Na,{})}),e.jsx(y,{path:"login",element:e.jsx(Ta,{})}),e.jsx(y,{path:"contact",element:e.jsx(Ca,{})}),e.jsx(y,{path:"faq",element:e.jsx(Sa,{})}),e.jsx(y,{path:"checkout",element:e.jsx(st,{})}),e.jsx(y,{path:"cookie-policy",element:e.jsx(Pa,{})}),e.jsx(y,{path:"privacy-policy",element:e.jsx(Aa,{})}),e.jsx(y,{path:"terms-condition",element:e.jsx(Fa,{})}),e.jsx(y,{path:"risk-disclosure",element:e.jsx(Ma,{})}),e.jsx(y,{path:"report-problem",element:e.jsx(Ea,{})}),e.jsx(y,{path:"blog",element:e.jsx(nt,{})}),e.jsx(y,{path:"blog/:blog",element:e.jsx(lt,{})}),e.jsxs(y,{path:"dashboard",element:e.jsx(La,{}),children:[e.jsx(y,{path:"Profile",element:e.jsx($a,{})}),e.jsx(y,{path:"billing",element:e.jsx(Ga,{})}),e.jsx(y,{path:"start-new-challenge",element:e.jsx(Va,{})}),e.jsx(y,{path:"withdraw",element:e.jsx(Ua,{})}),e.jsx(y,{path:"top-up-reset",element:e.jsx(qa,{})}),e.jsx(y,{path:"help",element:e.jsx(Wa,{})}),e.jsx(y,{path:"dashboard-contact",element:e.jsx(Ya,{})}),e.jsx(y,{path:"certificate",element:e.jsx(et,{})})]})]})})})}ge.createRoot(document.getElementById("root")).render(e.jsx(fe.StrictMode,{children:e.jsx(dt,{})}));
