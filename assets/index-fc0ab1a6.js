...
`},{link:"blog-5",title:"Introduction to Forex Trading with The Funded Hub: A Beginner&apos;s Guide",para:`<span>Meta Description:</span> Explore the power of leverage
          ...
          `},{link:"blog-12",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function st(){let[a,t]=s.useState(1);const i=6,r=Math.ceil(ie.length/i),n=it(ie,i),l=(c,p)=>{t(p),n.jump(p)},o=Qe({palette:{mode:"dark"}});return e.jsxs(e.Fragment,{children:[e.jsx(E,{}),e.jsx("section",{className:"blog relative pt-32 sm:pt-48 pb-28 sm:pb-44 purple-shadow",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"header flex justify-between w-full",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.7rem] tracking-tight text-wht-gradient",children:"Blog"})}),e.jsx("div",{className:"blogs mt-12 grid sm:grid-cols-2 md:grid-cols-3 gap-6 relative",children:n.currentData().map((c,p)=>e.jsxs(h,{to:`/blog/${c.link}`,className:"single-blog p-[0.9rem] bg-light/20 backdrop-blur-3xl rounded-xl !relative",children:[e.jsx("div",{className:"blog-img rounded-md",children:e.jsx("img",{className:"rounded-md w-full h-full leading-none hidden",src:"",alt:""})}),e.jsxs("div",{className:"texts fmt-6 grid gap-3 pb-8",children:[e.jsx("h3",{className:"font-semibold",children:c.title}),e.jsx("div",{className:"blog-para-slice",children:e.jsx("p",{dangerouslySetInnerHTML:{__html:c.para.slice(0,140)+"...."}})}),e.jsx("div",{className:"date text-sm absolute bottom-3",children:c.date})]})]},c.title+p))}),e.jsx("div",{className:"pagination mt-10 flex justify-center",children:e.jsx(Ze,{theme:o,children:e.jsx(ea,{spacing:2,children:e.jsx(aa,{count:r,page:a,shape:"rounded",variant:"outlined",color:"secondary",onChange:l})})})})]})})}),e.jsx(D,{})]})}const rt=[{link:"blog-1",title:"Leveraging Leverage: A Guide for Forex Traders",date:"26 August 2023",para:`<span>Meta Description:</span> Explore the power of leverage
                  in forex trading and how it can magnify your potential gains
                  and losses. Discover how to use leverage wisely with valuable
                  insights throughout the post. Forex trading offers an
                  incredible opportunity for traders to capitalize on currency
...
`},{link:"blog-5",title:"Introduction to Forex Trading with The Funded Hub: A Beginner&apos;s Guide",para:`<span>Meta Description:</span> Explore the power of leverage
          ...
          `},{link:"blog-12",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function nt(){const{pathname:a}=T(),t=rt.filter(({link:i})=>i===a.slice(6));return e.jsxs(e.Fragment,{children:[e.jsx(E,{}),e.jsx("section",{className:"single-blog relative pt-32 sm:pt-48 pb-28 sm:pb-44 purple-shadow",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"flex justify-center items-center",children:e.jsx("div",{className:"blog-img p-[0.03rem] rounded-md",children:e.jsx("img",{className:"rounded-md",src:me,alt:""})})}),e.jsxs("div",{className:"blog-content",children:[e.jsx("div",{className:"heading",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.9rem] tracking-tight text-wht-gradient",children:t[0].title})}),e.jsxs("div",{className:"blog-wrap-data",children:[e.jsx("div",{className:"data",dangerouslySetInnerHTML:{__html:t[0].data}}),e.jsx("div",{className:"btn mt-10 m-auto max-w-[17rem]",children:e.jsx(h,{to:"/",className:"uppercase font-Montserrat text-sm font-semibold  transition-all duration-200 glowing-btn",children:"Get Funded now"})})]})]})]})})}),e.jsx(D,{})]})}function ot(){return e.jsxs("div",{className:"App",children:[e.jsx(ge,{children:e.jsxs(ye,{children:[e.jsx(b,{path:"/",element:e.jsx(Na,{})}),e.jsx(b,{path:"login",element:e.jsx(Ta,{})}),e.jsx(b,{path:"contact",element:e.jsx(Sa,{})}),e.jsx(b,{path:"faq",element:e.jsx(Ca,{})}),e.jsx(b,{path:"cookie-policy",element:e.jsx(Pa,{})}),e.jsx(b,{path:"privacy-policy",element:e.jsx(Aa,{})}),e.jsx(b,{path:"terms-condition",element:e.jsx(Fa,{})}),e.jsx(b,{path:"risk-disclosure",element:e.jsx(Ma,{})}),e.jsx(b,{path:"report-problem",element:e.jsx(Ea,{})}),e.jsx(b,{path:"blog",element:e.jsx(st,{})}),e.jsx(b,{path:"blog/:blog",element:e.jsx(nt,{})}),e.jsxs(b,{path:"dashboard",element:e.jsx(La,{}),children:[e.jsx(b,{path:"Profile",element:e.jsx(Ya,{})}),e.jsx(b,{path:"billing",element:e.jsx(Va,{})}),e.jsx(b,{path:"start-new-challenge",element:e.jsx(_a,{})}),e.jsx(b,{path:"withdraw",element:e.jsx(qa,{})}),e.jsx(b,{path:"top-up-reset",element:e.jsx(Wa,{})}),e.jsx(b,{path:"help",element:e.jsx($a,{})}),e.jsx(b,{path:"dashboard-contact",element:e.jsx(Ga,{})}),e.jsx(b,{path:"certificate",element:e.jsx(at,{})})]})]})}),e.jsx(tt,{})]})}fe.createRoot(document.getElementById("root")).render(e.jsx(ue.StrictMode,{children:e.jsx(ot,{})}));
