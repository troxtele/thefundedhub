     ...
     <p>
      ...
      <p>
        ...
        article directly following this one.
            ...
            </div>`}];return e.jsxs("section",{className:"home-faq relative pt-28 overflow-hidden",children:[e.jsx("div",{className:"border-b border-slate-400/10 left-1/2 transform -translate-x-1/2 absolute w-[80vw] m-auto  -mt-14"}),e.jsx("div",{className:"container relative z-10",children:e.jsxs("div",{className:"wrapper grid gap-8 justify-center items-center",children:[e.jsxs("div",{className:"heading flex flex-col gap-2 justify-center items-center text-center",children:[e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.7rem] tracking-tight text-wht-gradient",children:"FAQ"}),e.jsx("div",{className:"paras",children:e.jsxs("p",{children:["If you don't find an answer in the frequently asked questions don't hesitate to"," ",e.jsx(l,{to:"/contact",className:"underline font-semibold",children:"contact us"})]})})]}),e.jsx("div",{className:"articles md:max-w-[60rem] m-auto grid gap-5",children:t.map((s,n)=>e.jsx(Ee,{heading:s.name,para:s.data,openFaq:a,i:n},n))}),e.jsx("div",{className:"readmore flex justify-center mb-12 xs:mb-24 md:mb-32",children:e.jsx(l,{to:"faq",className:"text-xs x:text-sm font-bold py-2 px-10 border-2 border-primary/20 rounded-3xl",children:"Visit FAQ Page"})})]})}),e.jsx("div",{className:"circle-shadow absolute grid justify-end items-end opacity-[23%] bottom-0 right-0 w-full h-full max-w-[40rem]",children:e.jsx("img",{src:I,alt:"circle-shadow"})})]})}function Pe(){const{pathname:a}=w(),[t,s]=i.useState(!1);return i.useEffect(()=>{window.scrollTo(0,0)},[a]),e.jsxs("div",{className:"font-light",children:[e.jsx(T,{}),e.jsx(Ae,{}),e.jsx(fe,{}),e.jsx(Ce,{setOpenFaq:s}),e.jsx(pe,{}),e.jsx(ve,{}),e.jsx(Ie,{openFaq:t}),e.jsx(S,{}),e.jsx("div",{className:"hidden h-0 w-0 opacity-0 left-0 visible md:invisible"}),e.jsx("script",{src:"./js/script.js"})]})}function He({props:a}){const[t,s]=a,[n,r]=i.useState(""),[c,d]=i.useState(""),[h,u]=i.useState(""),[f,m]=i.useState(""),[j,N]=i.useState(""),[F,y]=i.useState(""),[C,o]=i.useState(!1),[A,p]=i.useState(!1),E=oe.getAllCountries(),[H,L]=i.useState(!1);i.useEffect(()=>{n&&c&&h&&f.includes("@")&&j&&F&&A&&C?L(!0):L(!1)},[n,c,h,f,j,F,A,C]);const g=te();function q(x){document.querySelector("html").classList.remove("stop-scrolling"),g(x)}return e.jsxs("div",{className:`modal fixed inset-0 z-[99] transition-all duration-100 flex justify-center items-center ${t?"visible opacity-100":"invisible opacity-0"}`,children:[e.jsx("div",{className:`bg absolute inset-0 w-full h-full transition-all duration-200 backdrop-blur-xl ${t?"opacity-100 ":"opacity-0"}`,onClick:()=>s(!1)}),e.jsx("div",{className:"scroll h-screen",children:e.jsx("div",{className:"wrap overflow-hidden rounded-3xl h-full  sm:h-unset p-6 overflow-y-scroll sm:overflow-y-auto sm:flex justify-center items-center",children:e.jsxs("div",{className:`box relative max-w-[42rem] w-full text-main text-wht bg-light-gra transition-all uni-bg-gradient duration-300 rounded-3xl z-[999] py-6 my-3 px-6 ${t?"visible opacity-100":"invisible opacity-0"}`,children:[e.jsxs("form",{className:"grid gap-6 relative z-10 rounded-xl border-primary",children:[e.jsxs("div",{className:"heading grid gap-3 justify-start items-center",children:[e.jsx("div",{className:"wrap",children:e.jsx("h1",{className:"text-start text-xl xs:text-[1.8rem] font-medium text-wht-gradient pb-[0.2rem]",children:"Register"})}),e.jsx("div",{className:"register font-normal",children:e.jsxs("span",{children:["Already have an account?"," ",e.jsx("span",{onClick:()=>s(!1),className:"underline sm:cursor-pointer text-all",children:"Login"})]})})]}),e.jsxs("div",{className:"input-fields grid sm:grid-cols-2 gap-6 sm:gap-8 mt-2",children:[e.jsxs("div",{className:"left grid gap-5",children:[e.jsxs("div",{className:"same-line grid grid-cols-6 gap-4",children:[e.jsx("div",{className:"selecte-title col-span-2",children:e.jsxs("div",{className:"wrapper relative",children:[e.jsx("img",{className:"absolute right-3 top-1/2 transform -translate-y-1/2 w-4 xs:w-[1.rem]",src:v,alt:"arrow"}),e.jsxs("select",{id:"title",name:"title",autoFocus:!0,className:"form-control relative title-select w-full focus:outline-primary/70 border-none outline outline-2 outline-primary/30 py-2 sm:py-2.5 px-6 rounded-2xl transition-all duration-200 bg-transparent",children:[e.jsx("option",{value:"Mr.",children:"Mr."}),e.jsx("option",{value:"Mr.",children:"Ms."}),e.jsx("option",{value:"Mr.",children:"Mrs."}),e.jsx("option",{value:"Mr.",children:"Mx."})]})]})}),e.jsx("div",{className:"first-name col-span-4",children:e.jsx("input",{onChange:x=>r(x.target.value),value:n,name:"first-name",className:"email w-full focus:outline-primary/70 border-none outline outline-2 outline-primary/30  bg-transparent py-2 sm:py-2.5 px-6 rounded-2xl transition-all duration-200",type:"text",placeholder:"First Name"})})]}),e.jsx("div",{className:"last-name",children:e.jsx("input",{onChange:x=>d(x.target.value),value:c,name:"last-name",className:"email w-full focus:outline-primary/70 border-none outline outline-2 outline-primary/30  bg-transparent py-2 sm:py-2.5 px-6 rounded-2xl transition-all duration-200",type:"text",placeholder:"Last Name"})}),e.jsx("div",{className:"email",children:e.jsx("input",{onChange:x=>m(x.target.value),value:f,name:"email",className:"email w-full focus:outline-primary/70 border-none outline outline-2 outline-primary/30  bg-transparent py-2 sm:py-2.5 px-6 rounded-2xl transition-all duration-200",type:"email",placeholder:"Email"})})]}),e.jsxs("div",{className:"right grid gap-5",children:[e.jsx("div",{className:"country-residence",children:e.jsxs("div",{className:"wrapper relative",children:[e.jsx("img",{className:"absolute right-3 top-1/2 transform -translate-y-1/2 w-4 xs:w-[1.rem]",src:v,alt:"arrow"}),e.jsxs("select",{onChange:x=>u(x.target.value),value:h,id:"country",name:"country",className:"form-control relative w-full focus:outline-primary/70 border-none outline outline-2 outline-primary/30 py-2 sm:py-2.5 px-6 rounded-2xl transition-all duration-200 bg-transparent",children:[e.jsx("option",{defaultChecked:!0,children:"Choose a country"}),E.map((x,$)=>e.jsx("option",{value:x.name,children:x.name},$))]})]})}),e.jsx("div",{className:"password",children:e.jsx("input",{onChange:x=>N(x.target.value),value:j,name:"password",className:"email w-full focus:outline-primary/70 border-none outline outline-2 outline-primary/30  bg-transparent py-2 sm:py-2.5 px-6 rounded-2xl transition-all duration-200",type:"password",placeholder:"Password"})}),e.jsx("div",{className:"confirm-pass",children:e.jsx("input",{onChange:x=>y(x.target.value),value:F,name:"confirm-pass",className:"email w-full focus:outline-primary/70 border-none outline outline-2 outline-primary/30  bg-transparent py-2 sm:py-2.5 px-6 rounded-2xl transition-all duration-200",type:"password",placeholder:"Confirm Password"})})]})]}),e.jsxs("div",{className:"wrap grid sm:grid-cols-2 gap-6",children:[e.jsxs("div",{className:"checkboxs grid gap-3 justify-start max-w-[35rem] mt-2",children:[e.jsxs("div",{className:"checkbox flex gap-3 justify-start items-center",children:[e.jsx("input",{onInput:()=>o(!C),type:"checkbox",id:"checkbox1",className:"custom-checkbox"}),e.jsxs("label",{htmlFor:"checkbox1",className:"sm:cursor-pointer font-Montserrat font-medium text-sm",children:["I agree to the"," ",e.jsx("span",{onClick:()=>q("/terms-condition"),className:"underline text-all cursor-pointer",children:"terms and conditions"})]})]}),e.jsxs("div",{className:"checkbox flex gap-3 justify-start items-center",children:[e.jsx("input",{onInput:()=>p(!A),type:"checkbox",id:"checkbox2",className:"custom-checkbox"}),e.jsxs("label",{htmlFor:"checkbox2",className:"sm:cursor-pointer font-Montserrat font-medium text-sm",children:["I accept the"," ",e.jsx("span",{onClick:()=>q("/privacy-policy"),className:"underline text-all cursor-pointer",children:"privacy policy"})]})]}),e.jsxs("div",{className:"checkbox flex gap-3 justify-start items-center",children:[e.jsx("input",{type:"checkbox",id:"checkbox3",className:"custom-checkbox"}),e.jsx("label",{htmlFor:"checkbox3",className:"sm:cursor-pointer font-Montserrat font-medium text-sm",children:"Subscribe to our newsletter"})]})]}),e.jsx("div",{className:"login-btn mt-6 grid justify-center items-center w-full",children:e.jsx("button",{onClick:()=>H?s(!1):"",className:`py-2.5 sm:py-3 px-16 sm:px-20 transition-all duration-300 rounded-3xl font-Montserrat font-semibold ${H?"bg-blu hover:opacity-70":" !cursor-default bg-blu/20"}`,children:"Sign Up"})})]})]}),e.jsx("div",{className:"wrap",onClick:()=>s(!1),children:e.jsx("div",{className:"cross p-2 absolute cursor-pointer text-xl sm:text-2xl text-dim-gray right-4 top-4 z-50",children:e.jsx(K,{})})})]})})})]})}function Le(){const[a,t]=i.useState(""),[s,n]=i.useState(""),[r,c]=i.useState(!1),[d,h]=i.useState(!1);i.useEffect(()=>{const m=document.querySelector("html");r||d?m.classList.add("stop-scrolling"):m.classList.remove("stop-scrolling")},[r,d]);const{pathname:u}=w();i.useEffect(()=>{window.scrollTo(0,0)},[u]);const f=m=>{m.preventDefault()};return e.jsxs("main",{className:"login min-h-screen relative pt-32 md:py-32 overflow-hidden",children:[e.jsx("header",{className:"z-50 left-0 right-0 transition-all duration-300 border-b border-transparent py-2 sm:py-6 absolute top-0",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"wrapper flex mt-4 md:mt-0 justify-start md:justify-between",children:[e.jsx(l,{to:"/",className:"main-logo",children:e.jsx("img",{className:"max-w-[8rem] sm:max-w-[10rem]",src:P,alt:"TheFundedHub"})}),e.jsx("nav",{className:"nav-links hidden md:flex text-wht font-light justify-center items-center",children:e.jsx("div",{className:"item grid justify-center items-center",children:e.jsxs("ul",{className:"flex flex-wrap gap-4 justify-center items-center",children:[e.jsx("li",{children:e.jsx(l,{to:"/terms-condition",className:"text-[0.8rem]",children:"Term and Condition"})}),e.jsx("li",{children:e.jsx(l,{to:"/privacy-policy",className:"text-[0.8rem]",children:"Privacy Policy"})}),e.jsx("li",{children:e.jsx(l,{to:"/cookie-policy",className:"text-[0.8rem]",children:"Cookie Policy"})}),e.jsx("li",{children:e.jsx(l,{to:"/risk-disclosure",className:"text-[0.8rem]",children:"Risk Disclosure"})}),e.jsx("li",{children:e.jsx(l,{to:"/report-problem",className:"text-[0.8rem]",children:"Report a problem"})})]})})})]})})}),e.jsxs("section",{className:"relative",children:[e.jsx("div",{className:"container relative",children:e.jsx("div",{className:"wrapper z-10 relative flex justify-center items-center min-h-[40vh] md:pt-20 pb-24 sm:pb-36",children:e.jsxs("form",{className:"grid gap-3 p-7 relative z-10 rounded-2xl uni-bg-gradient border-primary max-w-[30rem] w-full global-shadow ",onSubmit:m=>f(m),children:[e.jsxs("div",{className:"heading grid gap-3 justify-start items-center",children:[e.jsx("div",{className:"wrap",children:e.jsx("h1",{className:"text-start text-xl xs:text-[1.8rem] font-medium text-wht-gradient pb-[0.2rem]",children:"Sign in"})}),e.jsx("div",{className:"register font-normal",children:e.jsxs("span",{children:["New user?"," ",e.jsx("span",{onClick:()=>h(!0),className:"underline sm:cursor-pointer text-all",children:"Register now"})]})})]}),e.jsx("div",{className:"email mt-3",children:e.jsx("input",{name:"email",value:a,onChange:m=>t(m.target.value),className:"email w-full focus:outline-primary/80 border-none outline outline-2 outline-primary/50 bg-transparent py-2 sm:py-2.5 px-6 rounded-2xl transition-all duration-200",type:"email",placeholder:"Email"})}),e.jsx("div",{className:"forget-pass text-end",children:e.jsx("a",{onClick:()=>c(!0),href:"#",className:"underline font-Montserrat font-medium text-sm",children:"Forgot Password"})}),e.jsx("div",{className:"Passwopasswordrd",children:e.jsx("input",{name:"password",value:s,onChange:m=>n(m.target.value),className:"email w-full focus:outline-primary/80 border-none outline outline-2 outline-primary/50 bg-transparent py-2 sm:py-2.5 px-6 rounded-2xl transition-all duration-200",type:"password",placeholder:"Password"})}),e.jsx("div",{className:"wrapper flex gap-3 flex-col sm:flex-row justify-between items-start sm:items-center mt-1",children:e.jsxs("div",{className:"remember flex gap-3 justify-center items-center",children:[e.jsx("input",{type:"checkbox",id:"remeber",className:"custom-checkbox"}),e.jsx("label",{htmlFor:"remeber",className:"sm:cursor-pointer text-sm font-Montserrat font-medium",children:"Remember me"})]})}),e.jsx("div",{className:"login-btn mt-10 flex justify-center items-center",children:e.jsx("div",{onClick:f,className:"py-2.5 px-16 transition-all duration-300 rounded-3xl font-Montserrat font-semibold grd-btn-wht pink-glowing-btn",children:"Login"})}),e.jsxs("div",{className:"signup grid gap-4 mt-2",children:[e.jsx("div",{className:"heading flex justify-center items-cente font-Montserrat font-semiboldr",children:e.jsx("h5",{children:"Or sign in with:"})}),e.jsxs("div",{className:"logos flex justify-center items-center gap-3",children:[e.jsx("a",{href:"#",className:"logo h-[2.7rem] w-[2.7rem] sm:h-[3rem] sm:w-[3rem] rounded-full border-2 flex justify-center items-center",children:e.jsx(re,{className:" w-[1.4rem] h-[1.4rem] sm:w-[1.8rem] sm:h-[1.8rem]"})}),e.jsx("a",{href:"#",className:"logo h-[2.7rem] w-[2.7rem] sm:h-[3rem] sm:w-[3rem] rounded-full border-2 flex justify-center items-center",children:e.jsx(se,{className:"w-[1.4rem] h-[1.4rem] sm:w-[1.8rem] sm:h-[1.8rem]"})})]})]})]})})}),e.jsx("div",{className:"circle-shadow absolute opacity-[15%] -top-[100%] -left-[50%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:b,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow absolute opacity-[20%] top-[40%] -right-[20%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:b,alt:"circle-shadow"})})]}),e.jsxs("div",{className:`modal fixed inset-0 z-[99] transition-all duration-100 flex justify-center items-center overflow-hidden ${r?"visible opacity-100":"invisible opacity-0"}`,children:[e.jsx("div",{className:`bg absolute inset-0 w-full h-full transition-all duration-200 backdrop-blur-xl ${r?"opacity-100 ":"opacity-0"}`,onClick:()=>c(!1)}),e.jsxs("div",{className:`box relative m-6 max-w-[500px] w-full text-main text-wht bg-light-gray uni-bg-gradient transition-all duration-300 rounded-3xl z-[999] py-10 px-6 ${r?"visible opacity-100":"invisible opacity-0"}`,children:[e.jsxs("form",{className:"content grid w-full text-center gap-4 font-semibold",children:[e.jsx("div",{className:"heading text-2xl",children:e.jsx("h3",{children:"Password Recovery"})}),e.jsxs("p",{className:"font-light font-Montserrat text-[1.05rem]",children:["We will send a password recovery link to ",e.jsx("br",{})," your e-mail"]}),e.jsxs("div",{className:"email w-full relative mt-4",children:[e.jsx("input",{name:"email",className:"email w-full focus:outline-primary/80 border-none outline outline-2 outline-primary/50 bg-transparent py-2 sm:py-2.5 px-6 rounded-2xl transition-all duration-200",type:"email",placeholder:"Email"}),e.jsx("div",{className:"arrow absolute right-3 top-1/2 transform -translate-y-1/2",children:e.jsx(ne,{className:"text-3xl text-thin text-primary/[78%]"})})]}),e.jsx("div",{className:"confirm-btn mt-8 flex justify-center items-center",children:e.jsx("button",{className:"py-2 sm:py-2.5 px-12 sm:px-16 grd-btn-wht rounded-3xl font-Montserrat font-semibold",children:"Confirm"})})]}),e.jsx("div",{className:"cross",onClick:()=>c(!1),children:e.jsx(K,{className:"absolute cursor-pointer text-xl sm:text-2xl text-dim-gray right-4 md:right-6 top-4 md:top-6"})})]})]}),e.jsx(He,{props:[d,h]}),e.jsx("footer",{className:"z-50 relative md:hidden left-0 right-0 transition-all duration-300 border-b border-transparent py-4 pb-10",children:e.jsx("div",{className:"container",children:e.jsx("div",{className:"wrapper flex flex-col md:flex-row justify-between gap-8",children:e.jsx("nav",{className:"nav-links text-wht font-light flex justify-center items-center",children:e.jsx("div",{className:"item grid justify-center items-center",children:e.jsxs("ul",{className:"flex flex-wrap gap-4 justify-center items-center",children:[e.jsx("li",{children:e.jsx(l,{to:"/terms-condition",className:"text-[0.8rem]",children:"Term and Condition"})}),e.jsx("li",{children:e.jsx(l,{to:"/privacy-policy",className:"text-[0.8rem]",children:"Privacy Policy"})}),e.jsx("li",{children:e.jsx(l,{to:"/cookie-policy",className:"text-[0.8rem]",children:"Cookie Policy"})}),e.jsx("li",{children:e.jsx(l,{to:"/risk-disclosure",className:"text-[0.8rem]",children:"Risk Disclosure"})}),e.jsx("li",{children:e.jsx(l,{to:"/report-problem",className:"text-[0.8rem]",children:"Report a problem"})})]})})})})})})]})}function _({clr:a,header:t}){const[s,n]=i.useState(""),[r,c]=i.useState(""),[d,h]=i.useState(""),[u,f]=i.useState(""),[m,j]=i.useState(""),[N,F]=i.useState(""),[y,C]=i.useState(!0),[o,A]=i.useState(!0),[p,E]=i.useState(!1);i.useEffect(()=>{/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(d)&&d!==""?A(!0):p&&A(!1)},[d,y]);const H=()=>{s&&r&&o&&u&&m!==""?D.post("https://api.thefundedhub.com//v1/website/questions",{firstName:s,lastName:r,email:d,subject:u,message:m}).then(g=>{console.log(g),F("success"),n(""),c(""),h(""),f(""),j(""),C(!0),A(!0)}).catch(g=>{F("failed")}):(C(!1),E(!0))},L=g=>{g.preventDefault(),H(),F("")};return e.jsxs(e.Fragment,{children:[e.jsxs("form",{className:`grid gap-6 sm:gap-8 md:gap-10 px-4 py-6 sm:p-8 relative z-10 rounded-3xl border-primary backdrop-blur-3xl global-shadow  ${a==="dash-bar-clr"?"contact-clr":"uni-bg-gradient"}`,children:[e.jsx("div",{className:"head",children:e.jsx("h3",{className:"text-xl",children:t||"Have questions?"})}),e.jsxs("div",{className:"inputs grid sm:grid-cols-2 gap-7",children:[e.jsxs("div",{className:"name relative",children:[e.jsx("input",{name:"name",onChange:g=>n(g.target.value),required:!0,className:`name w-full  bg-transparent backdrop-blur-3xl border-none outline outline-2  py-2 md:py-2.5 px-6 rounded-3xl transition-all duration-200 ${y||s!==""?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,type:"text",value:s,placeholder:"Name"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1.25rem] text-red-600 text-[0.66rem] ${y||s!==""?"invisible opacity-0":"visible opacity-100"}`,children:"This field is required"})]}),e.jsxs("div",{className:"surname relative",children:[e.jsx("input",{name:"surname",onChange:g=>c(g.target.value),value:r,className:`lastName w-full  bg-transparent backdrop-blur-3xl border-none outline outline-2  py-2 md:py-2.5 px-6 rounded-3xl transition-all duration-200 ${y||s!==""?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,placeholder:"Surname"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1.25rem] text-red-600 text-[0.66rem] ${y||r!==""?"invisible opacity-0":"visible opacity-100"}`,children:"This field is required"})]}),e.jsxs("div",{className:"email relative",children:[e.jsx("input",{name:"email",required:!0,onChange:g=>h(g.target.value),value:d,className:`email w-full  bg-transparent backdrop-blur-3xl border-none outline outline-2  py-2 md:py-2.5 px-6 rounded-3xl transition-all duration-200 ${o?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,type:"email",placeholder:"Email"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1.25rem] text-red-600 text-[0.66rem] ${o?"invisible opacity-0":"visible opacity-100"}`,children:"Please enter a valid email address"})]}),e.jsxs("div",{className:"subject relative",children:[e.jsx("input",{name:"subject",required:!0,onChange:g=>f(g.target.value),value:u,className:`subject w-full  bg-transparent backdrop-blur-3xl border-none outline outline-2  py-2 md:py-2.5 px-6 rounded-3xl transition-all duration-200 ${y||u!==""?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,type:"text",placeholder:"Subject"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1.25rem] text-red-600 text-[0.66rem] ${y||u!==""?"invisible opacity-0":"visible opacity-100"}`,children:"This field is required"})]})]}),e.jsxs("div",{className:"textarea relative",children:[e.jsx("textarea",{onChange:g=>j(g.target.value),required:!0,value:m,className:`bg-transparent backdrop-blur-3xl border-none outline outline-2 p-4 rounded-xl transition-all duration-200 w-full min-h-[10rem] sm:min-h-[12rem] md:min-h-[15rem] ${y||m!==""?"outline-primary/30 focus:outline-primary/70 focus:ring-4 focus:ring-primary/30":"outline-red-700 focus:ring-4 focus:ring-red-600/40"}`,name:"message",id:"message",placeholder:"Comment"}),e.jsx("div",{className:`required absolute left-[0.5rem] -bottom-[1rem] text-red-600 text-[0.66rem] ${y||m!==""?"invisible opacity-0":"visible opacity-100"}`,children:"This field is required"})]}),e.jsx("div",{className:"login-btn flex justify-center items-center",children:e.jsx("button",{onClick:g=>L(g),className:"py-2.5 px-16 transition-all duration-300 rounded-3xl font-Montserrat font-semibold glowing-btn max-w-[12rem] cursor-pointer",children:"Send"})})]}),e.jsx("div",{className:`box  fixed z-[999999] top-[30%] transform -translate-y-1/2 -right-[3rem] lg:-right-[4rem]  text-main text-wht bg-light-gra transition-all border border-primary/10 backdrop-blur-3xl duration-300 rounded-l-full my-3 overflow-hidden p-3 sm:p-5 px-12 md:w-[30rem] text-center ${N==="success"?" bg-[#08be00] contact-send-popup":N==="failed"?"bg-red-600 contact-send-popup":"invisible opacity-0"}`,children:e.jsx("div",{className:"subscribe text-base sm:text-xl font-nomal text-center pr-[1.5rem]",children:N==="success"?e.jsx("div",{children:"Message Sent!"}):N==="failed"?e.jsx("div",{children:"Sorry, please try again :("}):""})})]})}function Oe(){const{pathname:a}=w();return i.useEffect(()=>{window.scrollTo(0,0)},[a]),e.jsxs(e.Fragment,{children:[e.jsx(T,{}),e.jsxs("section",{className:"contact relative pt-40 sm:pt-52 pb-28 sm:pb-44 overflow-hidden",children:[e.jsx("div",{className:"container z-10 relative",children:e.jsx("div",{className:"wrapper flex items-center justify-center w-full",children:e.jsxs("div",{className:"content grid md:grid-cols-3 gap-10 max-w-[75rem] w-full",children:[e.jsxs("div",{className:"left md:col-span-1",children:[e.jsxs("div",{className:"heading grid gap-2",children:[e.jsx("div",{className:"wrap",children:e.jsx("h3",{className:"text-3xl text-wht-gradient",children:"Contact Us"})}),e.jsxs("p",{children:["Questions? Doubts? ",e.jsx("br",{})," Please contact us anytime and our team will take care of you!"]})]}),e.jsx("div",{className:"mt-5",children:e.jsx(O,{})})]}),e.jsx("div",{className:"right md:col-span-2",children:e.jsx(_,{})})]})})}),e.jsx("div",{className:"circle-shadow absolute opacity-[33%] -top-[10%] -left-[50%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:b,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow absolute opacity-[25%] top-[40%] -right-[20%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:b,alt:"circle-shadow"})})]}),e.jsx(S,{})]})}function Me(){const{pathname:a}=w();return i.useEffect(()=>{window.scrollTo(0,0)},[a]),e.jsxs(e.Fragment,{children:[e.jsx(T,{}),e.jsxs("section",{className:"contact relative pb-28 pt-40 sm:pt-52 sm:pb-44 overflow-hidden",children:[e.jsx("div",{className:"container z-10 relative",children:e.jsx("div",{className:"wrapper flex items-center w-full",children:e.jsxs("div",{className:"content grid md:grid-cols-3 gap-10 max-w-[75rem] w-full m-auto",children:[e.jsxs("div",{className:"left md:col-span-1 break-all ",children:[e.jsxs("div",{className:"heading grid gap-2",children:[e.jsx("h3",{className:"text-3xl",children:"Report a Problem"}),e.jsxs("p",{children:["Did you notice any bug or technical error? ",e.jsx("br",{})," Please let us know!"]})]}),e.jsx("div",{className:"mt-5",children:e.jsx(O,{})})]}),e.jsx("div",{className:"right md:col-span-2",children:e.jsx(_,{header:"Contact Us"})})]})})}),e.jsx("div",{className:"circle-shadow absolute opacity-[15%] -top-[70%] -left-[50%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:b,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow absolute opacity-[20%] top-[40%] -right-[20%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:b,alt:"circle-shadow"})})]}),e.jsx(S,{})]})}function De({heading:a,para:t,fls:s}){const[n,r]=i.useState(0),[c,d]=i.useState(s),h=i.useRef(null);return i.useEffect(()=>{r(h.current.clientHeight)},[c]),e.jsxs("article",{className:"item rounded-xl global-shadow ",children:[e.jsxs("header",{onClick:()=>d(!c),className:"flex justify-between cursor-pointer py-3 px-4",children:[e.jsx("h3",{className:"text-[0.9rem] xs:text-base font-Montserrat font-semibold",children:e.jsx("div",{dangerouslySetInnerHTML:{__html:a}})}),e.jsx("div",{className:"arrow flex justify-center items-center ml-3",children:e.jsx("img",{className:`max-w-[1.4rem] transform-gpu transition-all duration-300 ${c?"rotate-180":""}`,src:v,alt:"arrow"})})]}),e.jsx("div",{style:{maxHeight:c?n+"px":"0"},className:"faq-content transition-all duration-300 overflow-hidden ",children:e.jsx("div",{ref:h,className:"wrapper",children:e.jsx("div",{className:"text-[0.9rem] xs:text-base px-4 pb-5 pt-4 border-t border-primary/20",children:e.jsx("div",{className:"faq-collaps",dangerouslySetInnerHTML:{__html:t}})})})})]})}let Re={General:[{name:"The Funded Hub: Empowering Traders, one step at a time",data:`<div className="paras">
              <p>
...
`},{link:"blog-5",img:"",title:"Introduction to Forex Trading with The Funded Hub: A Beginner's Guide",para:`<span></span> Explore the power of leverage
          ...
          `},{link:"blog-12",img:"",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function Ve(){let[a,t]=i.useState(1);const s=6,n=Math.ceil(R.length/s),r=Ue(R,s),c=(h,u)=>{t(u),r.jump(u)},d=le({palette:{mode:"dark"}});return e.jsxs(e.Fragment,{children:[e.jsx(T,{}),e.jsxs("section",{className:"blog relative pt-36 sm:pt-48 pb-28 sm:pb-44 overflow-hidden",children:[e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"header flex justify-between w-full",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.7rem] tracking-tight text-wht-gradient",children:"Blog"})}),e.jsx("div",{className:"blogs mt-12 grid sm:grid-cols-2 md:grid-cols-3 gap-6 relative",children:r.currentData().map((h,u)=>e.jsxs(l,{to:`/blog/${h.link}`,className:"single-blog p-[0.9rem] bg-light/20 backdrop-blur-3xl rounded-xl !relative global-shadow grid justify-between items-end gap-4",children:[e.jsx("div",{className:"blog-img rounded-md hidden",children:e.jsx("img",{className:"rounded-md w-full h-full leading-none",src:h.img,alt:h.alt})}),e.jsxs("div",{className:"texts fmt-6 grid gap-3 pb-8",children:[e.jsx("h3",{className:"font-semibold",children:h.title}),e.jsx("div",{className:"blog-para-slice",children:e.jsx("p",{dangerouslySetInnerHTML:{__html:h.para.slice(0,140)+"...."}})}),e.jsx("div",{className:"date text-sm absolute bottom-3",children:h.date})]})]},h.title+u))}),e.jsx("div",{className:"pagination mt-10 flex justify-center",children:e.jsx(ce,{theme:d,children:e.jsx(de,{spacing:2,children:e.jsx(he,{count:n,page:a,shape:"rounded",variant:"outlined",color:"secondary",onChange:c})})})})]})}),e.jsx("div",{className:"circle-shadow absolute opacity-[23%] -top-[10%] -left-[50%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:b,alt:"circle-shadow"})}),e.jsx("div",{className:"circle-shadow absolute opacity-[25%] top-[40%] -right-[20%] w-full h-full min-w-[10rem]",children:e.jsx("img",{src:b,alt:"circle-shadow"})})]}),e.jsx(S,{})]})}function Ye(){const{pathname:a}=w(),t=R.filter(({link:s})=>s===a.slice(6));return e.jsxs(e.Fragment,{children:[e.jsx(T,{}),e.jsx("section",{className:"single-blog relative pt-16f pt-24 sm:pt-20 pb-28 sm:pb-44 overflow-hidden",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"flex justify-center items-center blog-content",children:e.jsx("div",{className:"blog-img p-[0.03rem] rounded-md",children:e.jsx("img",{className:"rounded-md",src:"",alt:t.alt})})}),e.jsxs("div",{className:"blog-content ",children:[e.jsx("div",{className:"heading",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.9rem] tracking-tight text-wht-gradient",children:t[0].title})}),e.jsxs("div",{className:"blog-wrap-data global-shadow",children:[e.jsx("div",{className:"data ",dangerouslySetInnerHTML:{__html:t[0].data}}),e.jsx("div",{className:"btn mt-10 m-auto max-w-[17rem]",children:e.jsx(l,{link:"/#price-table",className:"uppercase font-Montserrat text-sm font-semibold  transition-all duration-200 glowing-btn",children:"Get Funded Now"})})]})]})]})})}),e.jsx(S,{})]})}G.initialize("G-0GFK77GQTB");G.send({hitType:"pageview",page:window.location.pathname});const Ge="ef72a2fc-1672-41b9-acd5-260aac3e06ba";function Ke(){return e.jsxs("div",{className:"App body-background",children:[e.jsx(Q,{children:e.jsxs(ie,{children:[e.jsx(k,{path:"/",element:e.jsx(Pe,{})}),e.jsx(k,{path:"login",element:e.jsx(Le,{})}),e.jsx(k,{path:"contact-us",element:e.jsx(Oe,{})}),e.jsx(k,{path:"report-problem",element:e.jsx(Me,{})}),e.jsx(k,{path:"faq",element:e.jsx(qe,{})}),e.jsx(k,{path:"cookie-policy",element:e.jsx($e,{})}),e.jsx(k,{path:"privacy-policy",element:e.jsx(We,{})}),e.jsx(k,{path:"terms-condition",element:e.jsx(ze,{})}),e.jsx(k,{path:"risk-disclosure",element:e.jsx(Be,{})}),e.jsx(k,{path:"blog",element:e.jsx(Ve,{})}),e.jsx(k,{path:"blog/:blog",element:e.jsx(Ye,{})})]})}),e.jsx(J,{defer:!0,zendeskKey:Ge,onLoaded:()=>console.log("is loaded")})]})}Z.createRoot(document.getElementById("root")).render(e.jsx(X.StrictMode,{children:e.jsx(Ke,{})}));
