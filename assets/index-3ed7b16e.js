...
`},{link:"blog-5",title:"Introduction to Forex Trading with The Funded Hub: A Beginner's Guide",para:`<span>Meta Description:</span> Explore the power of leverage
          ...
          `},{link:"blog-12",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function lt(){const{pathname:t}=w(),a=ot.filter(({link:s})=>s===t.slice(6));return e.jsxs(e.Fragment,{children:[e.jsx(P,{}),e.jsx("section",{className:"single-blog bg-dark relative pt-32 sm:pt-48 pb-28 sm:pb-44 purple-shadow",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"flex justify-center items-center",children:e.jsx("div",{className:"blog-img p-[0.03rem] rounded-md hidden",children:e.jsx("img",{className:"rounded-md",src:he,alt:""})})}),e.jsxs("div",{className:"blog-content",children:[e.jsx("div",{className:"heading",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.9rem] tracking-tight text-wht-gradient",children:a[0].title})}),e.jsxs("div",{className:"blog-wrap-data",children:[e.jsx("div",{className:"data",dangerouslySetInnerHTML:{__html:a[0].data}}),e.jsx("div",{className:"btn mt-10 m-auto max-w-[17rem]",children:e.jsx(p,{to:"/",className:"uppercase font-Montserrat text-sm font-semibold  transition-all duration-200 glowing-btn",children:"Get Funded now"})})]})]})]})})}),e.jsx(A,{})]})}function dt(){return e.jsxs("div",{className:"App",children:[e.jsx(ue,{children:e.jsxs(xe,{children:[e.jsx(v,{path:"/",element:e.jsx(ja,{})}),e.jsx(v,{path:"login",element:e.jsx(Na,{})}),e.jsx(v,{path:"contact",element:e.jsx(ka,{})}),e.jsx(v,{path:"faq",element:e.jsx(Ta,{})}),e.jsx(v,{path:"cookie-policy",element:e.jsx(Sa,{})}),e.jsx(v,{path:"privacy-policy",element:e.jsx(Ca,{})}),e.jsx(v,{path:"terms-condition",element:e.jsx(Pa,{})}),e.jsx(v,{path:"risk-disclosure",element:e.jsx(Aa,{})}),e.jsx(v,{path:"report-problem",element:e.jsx(Ma,{})}),e.jsx(v,{path:"blog",element:e.jsx(nt,{})}),e.jsx(v,{path:"blog/:blog",element:e.jsx(lt,{})}),e.jsxs(v,{path:"dashboard",element:e.jsx(Ua,{}),children:[e.jsx(v,{path:"Profile",element:e.jsx($a,{})}),e.jsx(v,{path:"billing",element:e.jsx(Ya,{})}),e.jsx(v,{path:"start-new-challenge",element:e.jsx(Ga,{})}),e.jsx(v,{path:"withdraw",element:e.jsx(za,{})}),e.jsx(v,{path:"top-up-reset",element:e.jsx(qa,{})}),e.jsx(v,{path:"help",element:e.jsx(Wa,{})}),e.jsx(v,{path:"dashboard-contact",element:e.jsx(Va,{})}),e.jsx(v,{path:"certificate",element:e.jsx(at,{})})]}),e.jsx(v,{path:"thank-you",element:e.jsx(tt,{})}),e.jsx(v,{path:"payment-error",element:e.jsx(st,{})})]})}),e.jsx(it,{})]})}me.createRoot(document.getElementById("root")).render(e.jsx(pe.StrictMode,{children:e.jsx(dt,{})}));
