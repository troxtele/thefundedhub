...
`},{link:"blog-5",title:"Introduction to Forex Trading with The Funded Hub: A Beginner&apos;s Guide",para:`<span>Meta Description:</span> Explore the power of leverage
          ...
          `},{link:"blog-12",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function Da(){const{pathname:a}=b(),t=Ba.filter(({link:i})=>i===a.slice(6));return e.jsxs(e.Fragment,{children:[e.jsx(C,{}),e.jsx("section",{className:"single-blog relative pt-32 sm:pt-48 pb-28 sm:pb-44 purple-shadow",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"flex justify-center items-center",children:e.jsx("div",{className:"blog-img p-[0.03rem] rounded-md",children:e.jsx("img",{className:"rounded-md",src:ce,alt:""})})}),e.jsxs("div",{className:"blog-content",children:[e.jsx("div",{className:"heading",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.9rem] tracking-tight text-wht-gradient",children:t[0].title})}),e.jsxs("div",{className:"blog-wrap-data",children:[e.jsx("div",{className:"data",dangerouslySetInnerHTML:{__html:t[0].data}}),e.jsx("div",{className:"btn mt-10 m-auto max-w-[17rem]",children:e.jsx(d,{to:"/",className:"uppercase font-Montserrat text-sm font-semibold  transition-all duration-200 glowing-btn",children:"Get Funded now"})})]})]})]})})}),e.jsx(P,{})]})}function Ra(){const[a,t]=s.useState(!0);return e.jsx(e.Fragment,{children:a?e.jsx("div",{className:"cookies fixed bottom-[2rem] z-[99999] w-full left-0 right-0",children:e.jsx("div",{className:"container",children:e.jsx("div",{className:"wrapper",children:e.jsxs("div",{className:"content relative p-5 max-w-[450px] bg-light/[17%] backdrop-blur-3xl rounded-3xl border-2 border-light",children:[e.jsx("div",{className:"top text-center sm:text-start",children:e.jsx("h3",{className:"font-medium text-xl sm:text-[1.7rem] tracking-tight text-wht-gradient pr-10",children:"This website uses cookies"})}),e.jsxs("div",{className:"bottom grid gap-6 mt-3 text-center sm:text-start",children:[e.jsx("p",{className:"lg:col-span-2 text-xs sm:text-sm",children:"This website uses cookies to help you navigate, as well as to provide a better user experience and analyze the use of our products and services."}),e.jsxs("div",{className:"btns flex flex-col xs:flex-row justify-center sm:justify-end gap-4",children:[e.jsx("div",{onClick:()=>t(!1),className:"btn flex justify-center sm:justify-end items-center sm:col-span-1 cursor-pointer",children:e.jsx("div",{className:"uppercase font-Montserrat text-sm font-semibold py-2 sm:py-3 w-[9.5rem] sm:w-[11rem] border-wht border text-wht rounded-3xl text-center flex justify-center items-center",children:"Disagree"})}),e.jsx("div",{onClick:()=>t(!1),className:"btn flex justify-center sm:justify-end items-center sm:col-span-1 cursor-pointer",children:e.jsx("div",{className:"uppercase font-Montserrat text-sm font-semibold py-2 sm:py-3 rounded-3xl w-[9.5rem] sm:w-[11rem] text-center bg-white text-main-bg hover:opacity-80 transition-all duration-200",children:"I Agree"})})]})]}),e.jsx("div",{className:"wrap",onClick:()=>t(!1),children:e.jsx("div",{className:"cross p-2 absolute cursor-pointer text-xl sm:text-xl text-dim-gray right-4 top-4 z-50",children:e.jsx(O,{})})})]})})})}):""})}function za(){return e.jsxs("div",{className:"App",children:[e.jsx(ge,{children:e.jsxs(ve,{children:[e.jsx(g,{path:"/",element:e.jsx(Qe,{})}),e.jsx(g,{path:"login",element:e.jsx(Ze,{})}),e.jsx(g,{path:"contact",element:e.jsx(ea,{})}),e.jsx(g,{path:"faq",element:e.jsx(aa,{})}),e.jsx(g,{path:"checkout",element:e.jsx(Ia,{})}),e.jsx(g,{path:"cookie-policy",element:e.jsx(ta,{})}),e.jsx(g,{path:"privacy-policy",element:e.jsx(ia,{})}),e.jsx(g,{path:"terms-condition",element:e.jsx(sa,{})}),e.jsx(g,{path:"risk-disclosure",element:e.jsx(ra,{})}),e.jsx(g,{path:"report-problem",element:e.jsx(na,{})}),e.jsx(g,{path:"blog",element:e.jsx(Ha,{})}),e.jsx(g,{path:"blog/:blog",element:e.jsx(Da,{})}),e.jsxs(g,{path:"dashboard",element:e.jsx(ma,{}),children:[e.jsx(g,{path:"Profile",element:e.jsx(ba,{})}),e.jsx(g,{path:"billing",element:e.jsx(ja,{})}),e.jsx(g,{path:"withdraw",element:e.jsx(xa,{})}),e.jsx(g,{path:"top-up-reset",element:e.jsx(ya,{})}),e.jsx(g,{path:"help",element:e.jsx(va,{})}),e.jsx(g,{path:"dashboard-contact",element:e.jsx(wa,{})}),e.jsx(g,{path:"certificate",element:e.jsx(Aa,{})})]})]})}),e.jsx(Ra,{})]})}fe.createRoot(document.getElementById("root")).render(e.jsx(ue.StrictMode,{children:e.jsx(za,{})}));
