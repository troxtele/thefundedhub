...
`},{link:"blog-5",title:"Introduction to Forex Trading with The Funded Hub: A Beginner&apos;s Guide",para:`<span>Meta Description:</span> Explore the power of leverage
          ...
          `},{link:"blog-12",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function Ra(){let[a,t]=s.useState(1);const i=6,r=Math.ceil(X.length/i),n=ma(X,i),d=(h,m)=>{t(m),n.jump(m)},c=Ee({palette:{mode:"dark"}});return e.jsxs(e.Fragment,{children:[e.jsx(C,{}),e.jsx("section",{className:"blog relative pt-32 sm:pt-48 pb-28 sm:pb-44 purple-shadow",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"header flex justify-between w-full",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.7rem] tracking-tight text-wht-gradient",children:"Blog"})}),e.jsx("div",{className:"blogs mt-12 grid sm:grid-cols-2 md:grid-cols-3 gap-6 relative",children:n.currentData().map((h,m)=>e.jsxs(o,{to:`/blog/${h.link}`,className:"single-blog p-[0.9rem] bg-light/20 backdrop-blur-3xl rounded-xl !relative",children:[e.jsx("div",{className:"blog-img rounded-md",children:e.jsx("img",{className:"rounded-md w-full h-full leading-none",src:ie,alt:""})}),e.jsxs("div",{className:"texts mt-6 grid gap-3 pb-8",children:[e.jsx("h3",{className:"font-semibold",children:h.title}),e.jsx("div",{className:"blog-para-slice",children:e.jsx("p",{dangerouslySetInnerHTML:{__html:h.para.slice(0,140)+"...."}})}),e.jsx("div",{className:"date text-sm absolute bottom-3",children:h.date})]})]},h.title+m))}),e.jsx("div",{className:"pagination mt-10 flex justify-center",children:e.jsx(Ie,{theme:c,children:e.jsx(He,{spacing:2,children:e.jsx(Be,{count:r,page:a,shape:"rounded",variant:"outlined",color:"secondary",onChange:d})})})})]})})}),e.jsx(S,{})]})}const Oa=[{link:"blog-1",title:"Leveraging Leverage: A Guide for Forex Traders",date:"26 August 2023",para:`<span>Meta Description:</span> Explore the power of leverage
                  in forex trading and how it can magnify your potential gains
                  and losses. Discover how to use leverage wisely with valuable
                  insights throughout the post. Forex trading offers an
                  incredible opportunity for traders to capitalize on currency
...
`},{link:"blog-5",title:"Introduction to Forex Trading with The Funded Hub: A Beginner&apos;s Guide",para:`<span>Meta Description:</span> Explore the power of leverage
          ...
          `},{link:"blog-12",title:"Breakout Trading: Identifying and Riding Trends",para:`In the fast-paced world of forex trading, staying ahead of the
            ...
            </div>`}];function La(){const{pathname:a}=b(),t=Oa.filter(({link:i})=>i===a.slice(6));return e.jsxs(e.Fragment,{children:[e.jsx(C,{}),e.jsx("section",{className:"single-blog relative pt-32 sm:pt-48 pb-28 sm:pb-44 purple-shadow",children:e.jsx("div",{className:"container z-10 relative",children:e.jsxs("div",{className:"wrapper max-w-[75rem] m-auto w-full",children:[e.jsx("div",{className:"flex justify-center items-center",children:e.jsx("div",{className:"blog-img p-[0.03rem] rounded-md",children:e.jsx("img",{className:"rounded-md",src:ie,alt:""})})}),e.jsxs("div",{className:"blog-content",children:[e.jsx("div",{className:"heading",children:e.jsx("h2",{className:"font-medium text-2xl xs:text-[1.9rem] tracking-tight text-wht-gradient",children:t[0].title})}),e.jsxs("div",{className:"blog-wrap-data",children:[e.jsx("div",{className:"data",dangerouslySetInnerHTML:{__html:t[0].data}}),e.jsx("div",{className:"btn mt-10 m-auto max-w-[17rem]",children:e.jsx(o,{to:"/",className:"uppercase font-Montserrat text-sm font-semibold  transition-all duration-200 glowing-btn",children:"Get Funded now"})})]})]})]})})}),e.jsx(S,{})]})}function za(){return e.jsx("div",{className:"App",children:e.jsx(de,{children:e.jsxs(pe,{children:[e.jsx(g,{path:"/",element:e.jsx(aa,{})}),e.jsx(g,{path:"login",element:e.jsx(ia,{})}),e.jsx(g,{path:"contact",element:e.jsx(sa,{})}),e.jsx(g,{path:"faq",element:e.jsx(ra,{})}),e.jsx(g,{path:"checkout",element:e.jsx(Da,{})}),e.jsx(g,{path:"cookie-policy",element:e.jsx(na,{})}),e.jsx(g,{path:"privacy-policy",element:e.jsx(oa,{})}),e.jsx(g,{path:"terms-condition",element:e.jsx(la,{})}),e.jsx(g,{path:"risk-disclosure",element:e.jsx(da,{})}),e.jsx(g,{path:"report-problem",element:e.jsx(ca,{})}),e.jsx(g,{path:"blog",element:e.jsx(Ra,{})}),e.jsx(g,{path:"blog/:blog",element:e.jsx(La,{})}),e.jsxs(g,{path:"dashboard",element:e.jsx(ga,{}),children:[e.jsx(g,{path:"Profile",element:e.jsx(Na,{})}),e.jsx(g,{path:"billing",element:e.jsx(Ta,{})}),e.jsx(g,{path:"withdraw",element:e.jsx(ba,{})}),e.jsx(g,{path:"top-up-reset",element:e.jsx(ja,{})}),e.jsx(g,{path:"help",element:e.jsx(wa,{})}),e.jsx(g,{path:"dashboard-contact",element:e.jsx(ka,{})}),e.jsx(g,{path:"certificate",element:e.jsx(Ea,{})})]})]})})})}le.createRoot(document.getElementById("root")).render(e.jsx(oe.StrictMode,{children:e.jsx(za,{})}));
